...
if(PRAGMA_WITH_PFM)
    pr_install_git_repository(pfm "https://github.com/Silverlan/pfm.git" "97886b56fa5b22369d54fe45cdff3c80ca8ffca3" "addons/filmmaker")
...
if(PRAGMA_WITH_COMMON_MODULES)
    ...
    if(NOT TARGET pr_mount_external)
        pr_install_git_release(mount_external "Silverlan/pr_mount_external_prebuilt" "modules" "2026-04-18")
    endif()
    if(NOT TARGET pr_rig)
        pr_install_git_release(rig "Silverlan/pr_rig_prebuilt" "addons" "2026-04-18")
    endif()
    if(NOT TARGET pr_ik)
        pr_install_git_release(ik "Silverlan/pr_ik_prebuilt" "modules" "2026-04-18")
    endif()
endif()
