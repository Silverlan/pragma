...
if(PRAGMA_WITH_PFM)
    pr_install_git_repository(pfm "https://github.com/Silverlan/pfm.git" "ab1a19012e6edb9be84fedbc98d39284d934f659" "addons/filmmaker")
    pr_install_git_repository(model_editor "https://github.com/Silverlan/pragma_model_editor.git" "70d88289d3f7fe45b86486df972d704fea83a6f4" "addons/tool_model_editor")
...
if(PRAGMA_WITH_COMMON_MODULES)
    ...
    if(NOT TARGET pr_mount_external)
        pr_install_git_release(mount_external "Silverlan/pr_mount_external_prebuilt" "modules" "2026-07-20")
    endif()
    if(NOT TARGET pr_rig)
        pr_install_git_release(rig "Silverlan/pr_rig_prebuilt" "addons" "2026-07-20")
    endif()
    if(NOT TARGET pr_ik)
        pr_install_git_release(ik "Silverlan/pr_ik_prebuilt" "modules" "2026-07-20")
    endif()
endif()
