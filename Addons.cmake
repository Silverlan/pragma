...
if(WITH_PFM)
    pr_install_git_repository(pfm "https://github.com/Silverlan/pfm.git" "d2f5850111b78b48f2464f7699b4ddda76718937" "addons/filmmaker")
...
if(WITH_COMMON_MODULES)
    ...
    if(NOT TARGET pr_mount_external)
        pr_install_git_release(mount_external "Silverlan/pr_mount_external_prebuilt" "modules" "2025-08-07")
    endif()
    if(NOT TARGET pr_rig)
        pr_install_git_release(rig "Silverlan/pr_rig_prebuilt" "addons" "2025-08-07")
    endif()
    if(NOT TARGET pr_ik)
        pr_install_git_release(ik "Silverlan/pr_ik_prebuilt" "modules" "2025-08-07")
    endif()
endif()
