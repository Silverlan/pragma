...
if(shader2d == nil) then return end
...
if(imgBuf == nil) then return end

-- Create texture
local imgCreateInfo = prosper.create_image_create_info(imgBuf)
local imgIn = prosper.create_image(imgBuf,imgCreateInfo)
local texIn = prosper.create_texture(imgIn,prosper.TextureCreateInfo(),prosper.ImageViewCreateInfo(),prosper.SamplerCreateInfo())
...
local texOut = prosper.create_texture(imgOut,prosper.TextureCreateInfo(),prosper.ImageViewCreateInfo(),prosper.SamplerCreateInfo())
