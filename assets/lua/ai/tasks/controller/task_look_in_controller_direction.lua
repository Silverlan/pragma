...
function ai.TaskLookInControllerDirection:__tostring() return "Look in controller direction" end
...
ai.TASK_LOOK_IN_CONTROLLER_DIRECTION = ai.TASK_LOOK_IN_CONTROLLER_DIRECTION or ai.register_task(ai.TaskLookInControllerDirection)
