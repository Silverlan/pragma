...
function ai.TaskFunction:__tostring()
	return "Function"
end
...
function ai.TaskFunction:SetStart(f)
	self.m_fcStart = f
end
function ai.TaskFunction:SetThink(f)
	self.m_fcThink = f
end
function ai.TaskFunction:SetStop(f)
	self.m_fcStop = f
end
