...
local function spray()
	...
	if(util.is_valid(entSpray)) then entSpray:Remove() end
...
console.register_variable("cl_logofile","error",console.FLAG_BIT_ARCHIVE,"Material name for the spraylogo.")
