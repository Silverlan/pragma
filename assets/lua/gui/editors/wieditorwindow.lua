...
function gui.WIEditorWindow:SetFrame(frame) self.m_pFrame = frame end
function gui.WIEditorWindow:GetFrame() return self.m_pFrame end
function gui.WIEditorWindow:GetTabbedPanel() return self.m_pTabbedPanel end
function gui.WIEditorWindow:AddTab(name)
	if(util.is_valid(self.m_pTabbedPanel) == false) then return end
...
function gui.WIEditorWindow:Update()
	if(util.is_valid(self.m_pTabbedPanel)) then self.m_pTabbedPanel:Update() end
end
