...
--- 
--- @param renderInfo debug.DrawInfo
--- @overload fun(n: math.Vector, d: number, renderInfo: debug.DrawInfo): 
...
--- @param renderInfo debug.DrawInfo
--- @overload fun(start: math.Vector, end_: math.Vector): 
--- @overload fun(start: math.Vector, end_: math.Vector, renderInfo: debug.DrawInfo): 
...
--- @param dist number
--- @param renderInfo debug.DrawInfo
--- @overload fun(dir: math.Vector, dist: number, angle: number, renderInfo: debug.DrawInfo, segmentCount: int): 
...
--- @param renderInfo debug.DrawInfo
--- @overload fun(startRadius: number, dir: math.Vector, dist: number, endRadius: number, renderInfo: debug.DrawInfo, segmentCount: int): 
...
--- @param radius number
--- @param renderInfo debug.DrawInfo
--- @overload fun(radius: number, dir: math.Vector, dist: number, renderInfo: debug.DrawInfo, segmentCount: int): 
