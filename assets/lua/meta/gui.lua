...
--- 
--- @param drawInfo gui.Web.DrawInfo
--- @param drawState struct wgui::DrawState
--- @overload fun(drawInfo: gui.Web.DrawInfo, drawState: struct wgui::DrawState, scissorOffset: math.Vector2i, scissorSize: math.Vector2i): 
--- @overload fun(drawInfo: gui.Web.DrawInfo, drawState: struct wgui::DrawState, scissorOffset: math.Vector2i, scissorSize: math.Vector2i, offsetParent: math.Vector2i): 
