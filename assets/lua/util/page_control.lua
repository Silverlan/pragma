...
function util.PageControl:SetPage(page) self:UpdatePage(page) end
function util.PageControl:GetItemCount() return self.m_itemCount end
function util.PageControl:GetMaxItemCount() return self.m_maxItemCount end
function util.PageControl:GetPage() return self.m_page end
function util.PageControl:GetItemOffset()
	return self.m_page *self:GetMaxItemCount()
end
function util.PageControl:GetPageCount() return math.ceil((self:GetItemCount() -1) /self:GetMaxItemCount()) end
...
function util.PageControl:GoToPreviousPage()
	...
	if(page < 0) then page = self:GetPageCount() -1 end
	self:SetPage(page)
end
