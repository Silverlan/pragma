...
def main():
	...
	if not Path(cmake_dir).is_dir():
		if platform == "win32":
			...
			http_extract("https://github.com/Kitware/CMake/releases/download/v4.2.3/cmake-4.2.3-linux-x86_64.tar.gz",format="tar.gz")
			mv("cmake-4.2.3-linux-x86_64", cmake_dir)
