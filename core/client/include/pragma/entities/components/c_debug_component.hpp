...
namespace pragma
{
	template<class TBaseComponent>
		class DLLCLIENT TCBaseDebugComponent
	...
	protected:
		virtual void OnEntityComponentAdded(BaseEntityComponent &component) override
		{
			...
			if(typeid(component) == typeid(CColorComponent))
			{
				...
				m_colorCallback = static_cast<CColorComponent&>(component).GetColorProperty()->AddCallback([this](std::reference_wrapper<const Color> oldColor,std::reference_wrapper<const Color> color) {
					ReloadDebugObject();
				});
			}
	...
	class DLLCLIENT CDebugTextComponent final
		: public TCBaseDebugComponent<BaseDebugTextComponent>,
	...
	class DLLCLIENT CBaseDebugOutlineComponent
		: public CBaseNetComponent
	{
	public:
		virtual void ReceiveData(NetPacket &packet) override;
	...
	class DLLCLIENT CDebugPointComponent final
		: public TCBaseDebugComponent<BaseDebugPointComponent>,
		public CBaseNetComponent
	{
	public:
	...
	class DLLCLIENT CDebugLineComponent final
		: public TCBaseDebugComponent<BaseDebugLineComponent>,
		public CBaseNetComponent
	{
	public:
	...
	class DLLCLIENT CDebugBoxComponent final
		: public TCBaseDebugComponent<BaseDebugBoxComponent>,
		public CBaseDebugOutlineComponent
	{
	public:
	...
	class DLLCLIENT CDebugSphereComponent final
		: public TCBaseDebugComponent<BaseDebugSphereComponent>,
		public CBaseDebugOutlineComponent
	{
	public:
	...
	class DLLCLIENT CDebugConeComponent final
		: public TCBaseDebugComponent<BaseDebugConeComponent>,
		public CBaseDebugOutlineComponent
	{
	public:
	...
	class DLLCLIENT CDebugCylinderComponent final
		: public TCBaseDebugComponent<BaseDebugCylinderComponent>,
		public CBaseDebugOutlineComponent
	{
	public:
	...
	class DLLCLIENT CDebugPlaneComponent final
		: public TCBaseDebugComponent<BaseDebugPlaneComponent>,
		public CBaseNetComponent
	{
	public:
