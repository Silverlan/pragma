...
#define REGISTER_PARTICLE_INITIALIZER(localname, classname) REGISTER_PARTICLE_MODIFIER(localname, classname, CParticleInitializer);
#define REGISTER_PARTICLE_OPERATOR(localname, classname) REGISTER_PARTICLE_MODIFIER(localname, classname, CParticleOperator);
#define REGISTER_PARTICLE_RENDERER(localname, classname) REGISTER_PARTICLE_MODIFIER(localname, classname, CParticleRenderer);
