...
namespace pragma {
	...
	class DLLCLIENT ShaderParticleRotational : public ShaderParticle2DBase {
	  ...
	  protected:
		virtual void GetParticleSystemOrientationInfo(const Mat4 &matrix, const CParticleSystemComponent &particle, Vector3 &up, Vector3 &right, float &nearZ, float &farZ, const Material *material = nullptr, const pragma::BaseEnvCameraComponent *cam = nullptr) const override;
