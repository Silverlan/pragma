...
void CStaticBvhUserComponent::InitializeLuaObject(lua::State *l) { return BaseStaticBvhUserComponent::InitializeLuaObject<std::remove_reference_t<decltype(*this)>>(l); }
