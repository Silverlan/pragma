...
pragma::gui::WIDebugHDRBloom::WIDebugHDRBloom() : WITexturedRect() {}

pragma::gui::WIDebugHDRBloom::~WIDebugHDRBloom()
{
...
void pragma::gui::WIDebugHDRBloom::UpdateBloomImage()
{
...
void pragma::gui::WIDebugHDRBloom::DoUpdate()
{
	...
	m_cbRenderHDRMap = pragma::get_cgame()->AddCallback("PostRenderScenes", FunctionCallback<>::Create(std::bind(&pragma::gui::WIDebugHDRBloom::UpdateBloomImage, this)));
