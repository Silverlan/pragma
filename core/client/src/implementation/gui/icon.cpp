...
pragma::gui::WIIcon::WIIcon() : WITexturedRect() {}

pragma::gui::WIIcon::~WIIcon() {}

void pragma::gui::WIIcon::Initialize() { WITexturedRect::Initialize(); }

void pragma::gui::WIIcon::SetClipping(uint32_t xStart, uint32_t yStart, uint32_t width, uint32_t height)
{
