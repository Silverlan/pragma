...
void Lua::Entity::Client::register_class(luabind::class_<CBaseEntity, pragma::ecs::BaseEntity> &classDef)
{
	...
	classDef.def("SendNetEvent", static_cast<void (*)(lua::State *, CBaseEntity &, nwm::Protocol, unsigned int)>(&SendNetEvent));
...
void Lua::Entity::Client::SendNetEvent(lua::State *l, CBaseEntity &ent, nwm::Protocol protocol, unsigned int eventId, const ::NetPacket &packet)
{
	switch(protocol) {
...
void Lua::Entity::Client::SendNetEvent(lua::State *l, CBaseEntity &ent, nwm::Protocol protocol, unsigned int eventId) { SendNetEvent(l, ent, protocol, eventId, {}); }
