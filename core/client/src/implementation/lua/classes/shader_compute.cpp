...
void Lua::ComputePipelineCreateInfo::AddSpecializationConstant(lua::State *l, prosper::ComputePipelineCreateInfo &pipelineInfo, uint32_t constantId, pragma::util::DataStream &ds) { Lua::PushBool(l, pipelineInfo.AddSpecializationConstant(constantId, ds->GetSize(), ds->GetData())); }
