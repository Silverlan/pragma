...
namespace Lua {
	namespace Vulkan {
		...
		namespace VKTimestampQuery {
			...
			static Lua::var<bool, int64_t> QueryResult(lua::State *l, TimestampQuery &hTimestampQuery);
		};
		namespace VKTimerQuery {
			static bool IsValid(lua::State *l, TimerQuery &hTimerQuery);
			static Lua::var<bool, int64_t> QueryResult(lua::State *l, TimerQuery &hTimerQuery);
		};
	};
};
...
void pragma::ClientState::RegisterVulkanLuaInterface(Lua::Interface &lua)
{
	...
	prosperMod[(luabind::def("create_buffer", static_cast<std::shared_ptr<prosper::IBuffer> (*)(prosper::IPrContext &, prosper::util::BufferCreateInfo &, pragma::util::DataStream &)>(&Lua::Vulkan::create_buffer), luabind::render_context_policy<1> {}),
	...
	prosperMod[luabind::namespace_("util")[(luabind::def("get_square_vertex_uv_buffer", &Lua::Vulkan::get_square_vertex_uv_buffer), luabind::def("get_square_vertex_buffer", &Lua::Vulkan::get_square_vertex_buffer), luabind::def("get_square_uv_buffer", &Lua::Vulkan::get_square_uv_buffer),
	  ...
	  luabind::def("allocate_temporary_buffer", static_cast<std::shared_ptr<prosper::IBuffer> (*)(lua::State *, pragma::util::DataStream &)>(&Lua::Vulkan::allocate_temporary_buffer)),
	...
	Lua::RegisterLibraryEnums(lua.GetState(), "prosper",
	  {{"FORMAT_UNKNOWN", pragma::math::to_integral(prosper::Format::Unknown)}, {"FORMAT_R4G4_UNORM_PACK8", pragma::math::to_integral(prosper::Format::R4G4_UNorm_Pack8)}, {"FORMAT_R4G4B4A4_UNORM_PACK16", pragma::math::to_integral(prosper::Format::R4G4B4A4_UNorm_Pack16)},
	    {"FORMAT_B4G4R4A4_UNORM_PACK16", pragma::math::to_integral(prosper::Format::B4G4R4A4_UNorm_Pack16)}, {"FORMAT_R5G6B5_UNORM_PACK16", pragma::math::to_integral(prosper::Format::R5G6B5_UNorm_Pack16)}, {"FORMAT_B5G6R5_UNORM_PACK16", pragma::math::to_integral(prosper::Format::B5G6R5_UNorm_Pack16)},
	    {"FORMAT_R5G5B5A1_UNORM_PACK16", pragma::math::to_integral(prosper::Format::R5G5B5A1_UNorm_Pack16)}, {"FORMAT_B5G5R5A1_UNORM_PACK16", pragma::math::to_integral(prosper::Format::B5G5R5A1_UNorm_Pack16)}, {"FORMAT_A1R5G5B5_UNORM_PACK16", pragma::math::to_integral(prosper::Format::A1R5G5B5_UNorm_Pack16)},
	    {"FORMAT_R8_UNORM", pragma::math::to_integral(prosper::Format::R8_UNorm)}, {"FORMAT_R8_SNORM", pragma::math::to_integral(prosper::Format::R8_SNorm)}, {"FORMAT_R8_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8_UScaled_PoorCoverage)},
	    {"FORMAT_R8_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8_SScaled_PoorCoverage)}, {"FORMAT_R8_UINT", pragma::math::to_integral(prosper::Format::R8_UInt)}, {"FORMAT_R8_SINT", pragma::math::to_integral(prosper::Format::R8_SInt)},
	    {"FORMAT_R8_SRGB", pragma::math::to_integral(prosper::Format::R8_SRGB)}, {"FORMAT_R8G8_UNORM", pragma::math::to_integral(prosper::Format::R8G8_UNorm)}, {"FORMAT_R8G8_SNORM", pragma::math::to_integral(prosper::Format::R8G8_SNorm)},
	    {"FORMAT_R8G8_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8_UScaled_PoorCoverage)}, {"FORMAT_R8G8_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8_SScaled_PoorCoverage)}, {"FORMAT_R8G8_UINT", pragma::math::to_integral(prosper::Format::R8G8_UInt)},
	    {"FORMAT_R8G8_SINT", pragma::math::to_integral(prosper::Format::R8G8_SInt)}, {"FORMAT_R8G8_SRGB_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8_SRGB_PoorCoverage)}, {"FORMAT_R8G8B8_UNORM_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8_UNorm_PoorCoverage)},
	    {"FORMAT_R8G8B8_SNORM_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8_SNorm_PoorCoverage)}, {"FORMAT_R8G8B8_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8_UScaled_PoorCoverage)},
	    {"FORMAT_R8G8B8_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8_SScaled_PoorCoverage)}, {"FORMAT_R8G8B8_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8_UInt_PoorCoverage)},
	    {"FORMAT_R8G8B8_SINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8_SInt_PoorCoverage)}, {"FORMAT_R8G8B8_SRGB_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8_SRGB_PoorCoverage)},
	    {"FORMAT_B8G8R8_UNORM_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8_UNorm_PoorCoverage)}, {"FORMAT_B8G8R8_SNORM_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8_SNorm_PoorCoverage)},
	    {"FORMAT_B8G8R8_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8_UScaled_PoorCoverage)}, {"FORMAT_B8G8R8_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8_SScaled_PoorCoverage)},
	    {"FORMAT_B8G8R8_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8_UInt_PoorCoverage)}, {"FORMAT_B8G8R8_SINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8_SInt_PoorCoverage)},
	    {"FORMAT_B8G8R8_SRGB_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8_SRGB_PoorCoverage)}, {"FORMAT_R8G8B8A8_UNORM", pragma::math::to_integral(prosper::Format::R8G8B8A8_UNorm)}, {"FORMAT_R8G8B8A8_SNORM", pragma::math::to_integral(prosper::Format::R8G8B8A8_SNorm)},
	    {"FORMAT_R8G8B8A8_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8A8_UScaled_PoorCoverage)}, {"FORMAT_R8G8B8A8_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R8G8B8A8_SScaled_PoorCoverage)},
	    {"FORMAT_R8G8B8A8_UINT", pragma::math::to_integral(prosper::Format::R8G8B8A8_UInt)}, {"FORMAT_R8G8B8A8_SINT", pragma::math::to_integral(prosper::Format::R8G8B8A8_SInt)}, {"FORMAT_R8G8B8A8_SRGB", pragma::math::to_integral(prosper::Format::R8G8B8A8_SRGB)},
	    {"FORMAT_B8G8R8A8_UNORM", pragma::math::to_integral(prosper::Format::B8G8R8A8_UNorm)}, {"FORMAT_B8G8R8A8_SNORM", pragma::math::to_integral(prosper::Format::B8G8R8A8_SNorm)}, {"FORMAT_B8G8R8A8_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8A8_UScaled_PoorCoverage)},
	    {"FORMAT_B8G8R8A8_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::B8G8R8A8_SScaled_PoorCoverage)}, {"FORMAT_B8G8R8A8_UINT", pragma::math::to_integral(prosper::Format::B8G8R8A8_UInt)}, {"FORMAT_B8G8R8A8_SINT", pragma::math::to_integral(prosper::Format::B8G8R8A8_SInt)},
	    {"FORMAT_B8G8R8A8_SRGB", pragma::math::to_integral(prosper::Format::B8G8R8A8_SRGB)}, {"FORMAT_A8B8G8R8_UNORM_PACK32", pragma::math::to_integral(prosper::Format::A8B8G8R8_UNorm_Pack32)}, {"FORMAT_A8B8G8R8_SNORM_PACK32", pragma::math::to_integral(prosper::Format::A8B8G8R8_SNorm_Pack32)},
	    {"FORMAT_A8B8G8R8_USCALED_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A8B8G8R8_UScaled_Pack32_PoorCoverage)}, {"FORMAT_A8B8G8R8_SSCALED_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A8B8G8R8_SScaled_Pack32_PoorCoverage)},
	    {"FORMAT_A8B8G8R8_UINT_PACK32", pragma::math::to_integral(prosper::Format::A8B8G8R8_UInt_Pack32)}, {"FORMAT_A8B8G8R8_SINT_PACK32", pragma::math::to_integral(prosper::Format::A8B8G8R8_SInt_Pack32)}, {"FORMAT_A8B8G8R8_SRGB_PACK32", pragma::math::to_integral(prosper::Format::A8B8G8R8_SRGB_Pack32)},
	    {"FORMAT_A2R10G10B10_UNORM_PACK32", pragma::math::to_integral(prosper::Format::A2R10G10B10_UNorm_Pack32)}, {"FORMAT_A2R10G10B10_SNORM_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2R10G10B10_SNorm_Pack32_PoorCoverage)},
	    {"FORMAT_A2R10G10B10_USCALED_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2R10G10B10_UScaled_Pack32_PoorCoverage)}, {"FORMAT_A2R10G10B10_SSCALED_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2R10G10B10_SScaled_Pack32_PoorCoverage)},
	    {"FORMAT_A2R10G10B10_UINT_PACK32", pragma::math::to_integral(prosper::Format::A2R10G10B10_UInt_Pack32)}, {"FORMAT_A2R10G10B10_SINT_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2R10G10B10_SInt_Pack32_PoorCoverage)},
	    {"FORMAT_A2B10G10R10_UNORM_PACK32", pragma::math::to_integral(prosper::Format::A2B10G10R10_UNorm_Pack32)}, {"FORMAT_A2B10G10R10_SNORM_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2B10G10R10_SNorm_Pack32_PoorCoverage)},
	    {"FORMAT_A2B10G10R10_USCALED_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2B10G10R10_UScaled_Pack32_PoorCoverage)}, {"FORMAT_A2B10G10R10_SSCALED_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2B10G10R10_SScaled_Pack32_PoorCoverage)},
	    {"FORMAT_A2B10G10R10_UINT_PACK32", pragma::math::to_integral(prosper::Format::A2B10G10R10_UInt_Pack32)}, {"FORMAT_A2B10G10R10_SINT_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::A2B10G10R10_SInt_Pack32_PoorCoverage)},
	    {"FORMAT_R16_UNORM", pragma::math::to_integral(prosper::Format::R16_UNorm)}, {"FORMAT_R16_SNORM", pragma::math::to_integral(prosper::Format::R16_SNorm)}, {"FORMAT_R16_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16_UScaled_PoorCoverage)},
	    {"FORMAT_R16_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16_SScaled_PoorCoverage)}, {"FORMAT_R16_UINT", pragma::math::to_integral(prosper::Format::R16_UInt)}, {"FORMAT_R16_SINT", pragma::math::to_integral(prosper::Format::R16_SInt)},
	    {"FORMAT_R16_SFLOAT", pragma::math::to_integral(prosper::Format::R16_SFloat)}, {"FORMAT_R16G16_UNORM", pragma::math::to_integral(prosper::Format::R16G16_UNorm)}, {"FORMAT_R16G16_SNORM", pragma::math::to_integral(prosper::Format::R16G16_SNorm)},
	    {"FORMAT_R16G16_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16_UScaled_PoorCoverage)}, {"FORMAT_R16G16_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16_SScaled_PoorCoverage)},
	    {"FORMAT_R16G16_UINT", pragma::math::to_integral(prosper::Format::R16G16_UInt)}, {"FORMAT_R16G16_SINT", pragma::math::to_integral(prosper::Format::R16G16_SInt)}, {"FORMAT_R16G16_SFLOAT", pragma::math::to_integral(prosper::Format::R16G16_SFloat)},
	    {"FORMAT_R16G16B16_UNORM_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16_UNorm_PoorCoverage)}, {"FORMAT_R16G16B16_SNORM_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16_SNorm_PoorCoverage)},
	    {"FORMAT_R16G16B16_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16_UScaled_PoorCoverage)}, {"FORMAT_R16G16B16_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16_SScaled_PoorCoverage)},
	    {"FORMAT_R16G16B16_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16_UInt_PoorCoverage)}, {"FORMAT_R16G16B16_SINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16_SInt_PoorCoverage)},
	    {"FORMAT_R16G16B16_SFLOAT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16_SFloat_PoorCoverage)}, {"FORMAT_R16G16B16A16_UNORM", pragma::math::to_integral(prosper::Format::R16G16B16A16_UNorm)},
	    {"FORMAT_R16G16B16A16_SNORM", pragma::math::to_integral(prosper::Format::R16G16B16A16_SNorm)}, {"FORMAT_R16G16B16A16_USCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16A16_UScaled_PoorCoverage)},
	    {"FORMAT_R16G16B16A16_SSCALED_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R16G16B16A16_SScaled_PoorCoverage)}, {"FORMAT_R16G16B16A16_UINT", pragma::math::to_integral(prosper::Format::R16G16B16A16_UInt)},
	    {"FORMAT_R16G16B16A16_SINT", pragma::math::to_integral(prosper::Format::R16G16B16A16_SInt)}, {"FORMAT_R16G16B16A16_SFLOAT", pragma::math::to_integral(prosper::Format::R16G16B16A16_SFloat)}, {"FORMAT_R32_UINT", pragma::math::to_integral(prosper::Format::R32_UInt)},
	    {"FORMAT_R32_SINT", pragma::math::to_integral(prosper::Format::R32_SInt)}, {"FORMAT_R32_SFLOAT", pragma::math::to_integral(prosper::Format::R32_SFloat)}, {"FORMAT_R32G32_UINT", pragma::math::to_integral(prosper::Format::R32G32_UInt)},
	    {"FORMAT_R32G32_SINT", pragma::math::to_integral(prosper::Format::R32G32_SInt)}, {"FORMAT_R32G32_SFLOAT", pragma::math::to_integral(prosper::Format::R32G32_SFloat)}, {"FORMAT_R32G32B32_UINT", pragma::math::to_integral(prosper::Format::R32G32B32_UInt)},
	    {"FORMAT_R32G32B32_SINT", pragma::math::to_integral(prosper::Format::R32G32B32_SInt)}, {"FORMAT_R32G32B32_SFLOAT", pragma::math::to_integral(prosper::Format::R32G32B32_SFloat)}, {"FORMAT_R32G32B32A32_UINT", pragma::math::to_integral(prosper::Format::R32G32B32A32_UInt)},
	    {"FORMAT_R32G32B32A32_SINT", pragma::math::to_integral(prosper::Format::R32G32B32A32_SInt)}, {"FORMAT_R32G32B32A32_SFLOAT", pragma::math::to_integral(prosper::Format::R32G32B32A32_SFloat)}, {"FORMAT_R64_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64_UInt_PoorCoverage)},
	    {"FORMAT_R64_SINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64_SInt_PoorCoverage)}, {"FORMAT_R64_SFLOAT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64_SFloat_PoorCoverage)},
	    {"FORMAT_R64G64_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64_UInt_PoorCoverage)}, {"FORMAT_R64G64_SINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64_SInt_PoorCoverage)},
	    {"FORMAT_R64G64_SFLOAT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64_SFloat_PoorCoverage)}, {"FORMAT_R64G64B64_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64B64_UInt_PoorCoverage)},
	    {"FORMAT_R64G64B64_SINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64B64_SInt_PoorCoverage)}, {"FORMAT_R64G64B64_SFLOAT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64B64_SFloat_PoorCoverage)},
	    {"FORMAT_R64G64B64A64_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64B64A64_UInt_PoorCoverage)}, {"FORMAT_R64G64B64A64_SINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64B64A64_SInt_PoorCoverage)},
	    {"FORMAT_R64G64B64A64_SFLOAT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::R64G64B64A64_SFloat_PoorCoverage)}, {"FORMAT_B10G11R11_UFLOAT_PACK32", pragma::math::to_integral(prosper::Format::B10G11R11_UFloat_Pack32)},
	    {"FORMAT_E5B9G9R9_UFLOAT_PACK32", pragma::math::to_integral(prosper::Format::E5B9G9R9_UFloat_Pack32)}, {"FORMAT_D16_UNORM", pragma::math::to_integral(prosper::Format::D16_UNorm)}, {"FORMAT_X8_D24_UNORM_PACK32_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::X8_D24_UNorm_Pack32_PoorCoverage)},
	    {"FORMAT_D32_SFLOAT", pragma::math::to_integral(prosper::Format::D32_SFloat)}, {"FORMAT_S8_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::S8_UInt_PoorCoverage)}, {"FORMAT_D16_UNORM_S8_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::D16_UNorm_S8_UInt_PoorCoverage)},
	    {"FORMAT_D24_UNORM_S8_UINT_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::D24_UNorm_S8_UInt_PoorCoverage)}, {"FORMAT_D32_SFLOAT_S8_UINT", pragma::math::to_integral(prosper::Format::D32_SFloat_S8_UInt)},
	    {"FORMAT_BC1_RGB_UNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC1_RGB_UNorm_Block)}, {"FORMAT_BC1_RGB_SRGB_BLOCK", pragma::math::to_integral(prosper::Format::BC1_RGB_SRGB_Block)}, {"FORMAT_BC1_RGBA_UNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC1_RGBA_UNorm_Block)},
	    {"FORMAT_BC1_RGBA_SRGB_BLOCK", pragma::math::to_integral(prosper::Format::BC1_RGBA_SRGB_Block)}, {"FORMAT_BC2_UNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC2_UNorm_Block)}, {"FORMAT_BC2_SRGB_BLOCK", pragma::math::to_integral(prosper::Format::BC2_SRGB_Block)},
	    {"FORMAT_BC3_UNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC3_UNorm_Block)}, {"FORMAT_BC3_SRGB_BLOCK", pragma::math::to_integral(prosper::Format::BC3_SRGB_Block)}, {"FORMAT_BC4_UNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC4_UNorm_Block)},
	    {"FORMAT_BC4_SNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC4_SNorm_Block)}, {"FORMAT_BC5_UNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC5_UNorm_Block)}, {"FORMAT_BC5_SNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC5_SNorm_Block)},
	    {"FORMAT_BC6H_UFLOAT_BLOCK", pragma::math::to_integral(prosper::Format::BC6H_UFloat_Block)}, {"FORMAT_BC6H_SFLOAT_BLOCK", pragma::math::to_integral(prosper::Format::BC6H_SFloat_Block)}, {"FORMAT_BC7_UNORM_BLOCK", pragma::math::to_integral(prosper::Format::BC7_UNorm_Block)},
	    {"FORMAT_BC7_SRGB_BLOCK", pragma::math::to_integral(prosper::Format::BC7_SRGB_Block)}, {"FORMAT_ETC2_R8G8B8_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ETC2_R8G8B8_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ETC2_R8G8B8_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ETC2_R8G8B8_SRGB_Block_PoorCoverage)}, {"FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ETC2_R8G8B8A1_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ETC2_R8G8B8A1_SRGB_Block_PoorCoverage)}, {"FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ETC2_R8G8B8A8_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ETC2_R8G8B8A8_SRGB_Block_PoorCoverage)}, {"FORMAT_EAC_R11_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::EAC_R11_UNorm_Block_PoorCoverage)},
	    {"FORMAT_EAC_R11_SNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::EAC_R11_SNorm_Block_PoorCoverage)}, {"FORMAT_EAC_R11G11_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::EAC_R11G11_UNorm_Block_PoorCoverage)},
	    {"FORMAT_EAC_R11G11_SNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::EAC_R11G11_SNorm_Block_PoorCoverage)}, {"FORMAT_ASTC_4x4_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_4x4_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_4x4_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_4x4_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_5x4_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_5x4_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_5x4_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_5x4_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_5x5_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_5x5_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_5x5_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_5x5_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_6x5_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_6x5_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_6x5_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_6x5_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_6x6_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_6x6_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_6x6_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_6x6_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_8x5_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_8x5_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_8x5_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_8x5_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_8x6_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_8x6_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_8x6_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_8x6_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_8x8_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_8x8_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_8x8_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_8x8_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_10x5_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x5_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_10x5_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x5_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_10x6_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x6_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_10x6_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x6_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_10x8_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x8_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_10x8_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x8_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_10x10_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x10_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_10x10_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_10x10_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_12x10_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_12x10_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_12x10_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_12x10_SRGB_Block_PoorCoverage)}, {"FORMAT_ASTC_12x12_UNORM_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_12x12_UNorm_Block_PoorCoverage)},
	    {"FORMAT_ASTC_12x12_SRGB_BLOCK_POOR_COVERAGE", pragma::math::to_integral(prosper::Format::ASTC_12x12_SRGB_Block_PoorCoverage)},

	    {"RESULT_SUCCESS", pragma::math::to_integral(prosper::Result::Success)}, {"RESULT_NOT_READY", pragma::math::to_integral(prosper::Result::NotReady)}, {"RESULT_TIMEOUT", pragma::math::to_integral(prosper::Result::Timeout)}, {"RESULT_EVENT_SET", pragma::math::to_integral(prosper::Result::EventSet)},
	    {"RESULT_EVENT_RESET", pragma::math::to_integral(prosper::Result::EventReset)}, {"RESULT_INCOMPLETE", pragma::math::to_integral(prosper::Result::Incomplete)}, {"RESULT_ERROR_OUT_OF_HOST_MEMORY", pragma::math::to_integral(prosper::Result::ErrorOutOfHostMemory)},
	    {"RESULT_ERROR_OUT_OF_DEVICE_MEMORY", pragma::math::to_integral(prosper::Result::ErrorOutOfDeviceMemory)}, {"RESULT_ERROR_INITIALIZATION_FAILED", pragma::math::to_integral(prosper::Result::ErrorInitializationFailed)},
	    {"RESULT_ERROR_DEVICE_LOST", pragma::math::to_integral(prosper::Result::ErrorDeviceLost)}, {"RESULT_ERROR_MEMORY_MAP_FAILED", pragma::math::to_integral(prosper::Result::ErrorMemoryMapFailed)}, {"RESULT_ERROR_LAYER_NOT_PRESENT", pragma::math::to_integral(prosper::Result::ErrorLayerNotPresent)},
	    {"RESULT_ERROR_EXTENSION_NOT_PRESENT", pragma::math::to_integral(prosper::Result::ErrorExtensionNotPresent)}, {"RESULT_ERROR_FEATURE_NOT_PRESENT", pragma::math::to_integral(prosper::Result::ErrorFeatureNotPresent)},
	    {"RESULT_ERROR_INCOMPATIBLE_DRIVER", pragma::math::to_integral(prosper::Result::ErrorIncompatibleDriver)}, {"RESULT_ERROR_TOO_MANY_OBJECTS", pragma::math::to_integral(prosper::Result::ErrorTooManyObjects)},
	    {"RESULT_ERROR_FORMAT_NOT_SUPPORTED", pragma::math::to_integral(prosper::Result::ErrorFormatNotSupported)}, {"RESULT_ERROR_SURFACE_LOST_KHR", pragma::math::to_integral(prosper::Result::ErrorSurfaceLostKHR)},
	    {"RESULT_ERROR_NATIVE_WINDOW_IN_USE_KHR", pragma::math::to_integral(prosper::Result::ErrorNativeWindowInUseKHR)}, {"RESULT_SUBOPTIMAL_KHR", pragma::math::to_integral(prosper::Result::SuboptimalKHR)}, {"RESULT_ERROR_OUT_OF_DATE_KHR", pragma::math::to_integral(prosper::Result::ErrorOutOfDateKHR)},
	    {"RESULT_ERROR_INCOMPATIBLE_DISPLAY_KHR", pragma::math::to_integral(prosper::Result::ErrorIncompatibleDisplayKHR)}, {"RESULT_ERROR_VALIDATION_FAILED_EXT", pragma::math::to_integral(prosper::Result::ErrorValidationFailedEXT)},

	    {"SAMPLER_MIPMAP_MODE_LINEAR", pragma::math::to_integral(prosper::SamplerMipmapMode::Linear)}, {"SAMPLER_MIPMAP_MODE_NEAREST", pragma::math::to_integral(prosper::SamplerMipmapMode::Nearest)},

	    {"SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER", pragma::math::to_integral(prosper::SamplerAddressMode::ClampToBorder)}, {"SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE", pragma::math::to_integral(prosper::SamplerAddressMode::ClampToEdge)},
	    {"SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE", pragma::math::to_integral(prosper::SamplerAddressMode::MirrorClampToEdge)}, {"SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT", pragma::math::to_integral(prosper::SamplerAddressMode::MirroredRepeat)},
	    {"SAMPLER_ADDRESS_MODE_REPEAT", pragma::math::to_integral(prosper::SamplerAddressMode::Repeat)},

	    {"COMPARE_OP_ALWAYS", pragma::math::to_integral(prosper::CompareOp::Always)}, {"COMPARE_OP_EQUAL", pragma::math::to_integral(prosper::CompareOp::Equal)}, {"COMPARE_OP_GREATER", pragma::math::to_integral(prosper::CompareOp::Greater)},
	    {"COMPARE_OP_GREATER_OR_EQUAL", pragma::math::to_integral(prosper::CompareOp::GreaterOrEqual)}, {"COMPARE_OP_LESS", pragma::math::to_integral(prosper::CompareOp::Less)}, {"COMPARE_OP_LESS_OR_EQUAL", pragma::math::to_integral(prosper::CompareOp::LessOrEqual)},
	    {"COMPARE_OP_NEVER", pragma::math::to_integral(prosper::CompareOp::Never)}, {"COMPARE_OP_NOT_EQUAL", pragma::math::to_integral(prosper::CompareOp::NotEqual)},

	    {"BORDER_COLOR_FLOAT_OPAQUE_BLACK", pragma::math::to_integral(prosper::BorderColor::FloatOpaqueBlack)}, {"BORDER_COLOR_FLOAT_OPAQUE_WHITE", pragma::math::to_integral(prosper::BorderColor::FloatOpaqueWhite)},
	    {"BORDER_COLOR_floatRANSPARENT_BLACK", pragma::math::to_integral(prosper::BorderColor::FloatTransparentBlack)}, {"BORDER_COLOR_INT_OPAQUE_BLACK", pragma::math::to_integral(prosper::BorderColor::IntOpaqueBlack)},
	    {"BORDER_COLOR_INT_OPAQUE_WHITE", pragma::math::to_integral(prosper::BorderColor::IntOpaqueWhite)}, {"BORDER_COLOR_INT_TRANSPARENT_BLACK", pragma::math::to_integral(prosper::BorderColor::IntTransparentBlack)},

	    {"IMAGE_LAYOUT_UNDEFINED", pragma::math::to_integral(prosper::ImageLayout::Undefined)}, {"IMAGE_LAYOUT_GENERAL", pragma::math::to_integral(prosper::ImageLayout::General)}, {"IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL", pragma::math::to_integral(prosper::ImageLayout::ColorAttachmentOptimal)},
	    {"IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL", pragma::math::to_integral(prosper::ImageLayout::DepthStencilAttachmentOptimal)}, {"IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL", pragma::math::to_integral(prosper::ImageLayout::DepthStencilReadOnlyOptimal)},
	    {"IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL", pragma::math::to_integral(prosper::ImageLayout::ShaderReadOnlyOptimal)}, {"IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL", pragma::math::to_integral(prosper::ImageLayout::TransferSrcOptimal)},
	    {"IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL", pragma::math::to_integral(prosper::ImageLayout::TransferDstOptimal)}, {"IMAGE_LAYOUT_PREINITIALIZED", pragma::math::to_integral(prosper::ImageLayout::Preinitialized)}, {"IMAGE_LAYOUT_PRESENT_SRC_KHR", pragma::math::to_integral(prosper::ImageLayout::PresentSrcKHR)},

	    {"ATTACHMENT_LOAD_OP_LOAD", pragma::math::to_integral(prosper::AttachmentLoadOp::Load)}, {"ATTACHMENT_LOAD_OP_CLEAR", pragma::math::to_integral(prosper::AttachmentLoadOp::Clear)}, {"ATTACHMENT_LOAD_OP_DONT_CARE", pragma::math::to_integral(prosper::AttachmentLoadOp::DontCare)},

	    {"ATTACHMENT_STORE_OP_STORE", pragma::math::to_integral(prosper::AttachmentStoreOp::Store)}, {"ATTACHMENT_STORE_OP_DONT_CARE", pragma::math::to_integral(prosper::AttachmentStoreOp::DontCare)},

	    {"IMAGE_TYPE_1D", pragma::math::to_integral(prosper::ImageType::e1D)}, {"IMAGE_TYPE_2D", pragma::math::to_integral(prosper::ImageType::e2D)}, {"IMAGE_TYPE_3D", pragma::math::to_integral(prosper::ImageType::e3D)},

	    {"IMAGE_TILING_OPTIMAL", pragma::math::to_integral(prosper::ImageTiling::Optimal)}, {"IMAGE_TILING_LINEAR", pragma::math::to_integral(prosper::ImageTiling::Linear)},

	    {"IMAGE_VIEW_TYPE_1D", pragma::math::to_integral(prosper::ImageViewType::e1D)}, {"IMAGE_VIEW_TYPE_2D", pragma::math::to_integral(prosper::ImageViewType::e2D)}, {"IMAGE_VIEW_TYPE_3D", pragma::math::to_integral(prosper::ImageViewType::e3D)},
	    {"IMAGE_VIEW_TYPE_CUBE", pragma::math::to_integral(prosper::ImageViewType::Cube)}, {"IMAGE_VIEW_TYPE_1D_ARRAY", pragma::math::to_integral(prosper::ImageViewType::e1DArray)}, {"IMAGE_VIEW_TYPE_2D_ARRAY", pragma::math::to_integral(prosper::ImageViewType::e2DArray)},
	    {"IMAGE_VIEW_TYPE_CUBE_ARRAY", pragma::math::to_integral(prosper::ImageViewType::CubeArray)},

	    {"COMPONENT_SWIZZLE_IDENTITY", pragma::math::to_integral(prosper::ComponentSwizzle::Identity)}, {"COMPONENT_SWIZZLE_ZERO", pragma::math::to_integral(prosper::ComponentSwizzle::Zero)}, {"COMPONENT_SWIZZLE_ONE", pragma::math::to_integral(prosper::ComponentSwizzle::One)},
	    {"COMPONENT_SWIZZLE_R", pragma::math::to_integral(prosper::ComponentSwizzle::R)}, {"COMPONENT_SWIZZLE_G", pragma::math::to_integral(prosper::ComponentSwizzle::G)}, {"COMPONENT_SWIZZLE_B", pragma::math::to_integral(prosper::ComponentSwizzle::B)},
	    {"COMPONENT_SWIZZLE_A", pragma::math::to_integral(prosper::ComponentSwizzle::A)},

	    {"DESCRIPTOR_TYPE_SAMPLER", pragma::math::to_integral(prosper::DescriptorType::Sampler)}, {"DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER", pragma::math::to_integral(prosper::DescriptorType::CombinedImageSampler)},
	    {"DESCRIPTOR_TYPE_SAMPLED_IMAGE", pragma::math::to_integral(prosper::DescriptorType::SampledImage)}, {"DESCRIPTOR_TYPE_STORAGE_IMAGE", pragma::math::to_integral(prosper::DescriptorType::StorageImage)},
	    {"DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER", pragma::math::to_integral(prosper::DescriptorType::UniformTexelBuffer)}, {"DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER", pragma::math::to_integral(prosper::DescriptorType::StorageTexelBuffer)},
	    {"DESCRIPTOR_TYPE_UNIFORM_BUFFER", pragma::math::to_integral(prosper::DescriptorType::UniformBuffer)}, {"DESCRIPTOR_TYPE_STORAGE_BUFFER", pragma::math::to_integral(prosper::DescriptorType::StorageBuffer)},
	    {"DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC", pragma::math::to_integral(prosper::DescriptorType::UniformBufferDynamic)}, {"DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC", pragma::math::to_integral(prosper::DescriptorType::StorageBufferDynamic)},
	    {"DESCRIPTOR_TYPE_INPUT_ATTACHMENT", pragma::math::to_integral(prosper::DescriptorType::InputAttachment)},

	    {"QUERY_TYPE_OCCLUSION", pragma::math::to_integral(prosper::QueryType::Occlusion)}, {"QUERY_TYPE_PIPELINE_STATISTICS", pragma::math::to_integral(prosper::QueryType::PipelineStatistics)}, {"QUERY_TYPE_TIMESTAMP", pragma::math::to_integral(prosper::QueryType::Timestamp)},

	    {"PIPELINE_BIND_POINT_GRAPHICS", pragma::math::to_integral(prosper::PipelineBindPoint::Graphics)}, {"PIPELINE_BIND_POINT_COMPUTE", pragma::math::to_integral(prosper::PipelineBindPoint::Compute)},

	    {"PRIMITIVE_TOPOLOGY_POINT_LIST", pragma::math::to_integral(prosper::PrimitiveTopology::PointList)}, {"PRIMITIVE_TOPOLOGY_LINE_LIST", pragma::math::to_integral(prosper::PrimitiveTopology::LineList)}, {"PRIMITIVE_TOPOLOGY_LINE_STRIP", pragma::math::to_integral(prosper::PrimitiveTopology::LineStrip)},
	    {"PRIMITIVE_TOPOLOGY_TRIANGLE_LIST", pragma::math::to_integral(prosper::PrimitiveTopology::TriangleList)}, {"PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP", pragma::math::to_integral(prosper::PrimitiveTopology::TriangleStrip)},
	    {"PRIMITIVE_TOPOLOGY_TRIANGLE_FAN", pragma::math::to_integral(prosper::PrimitiveTopology::TriangleFan)}, {"PRIMITIVE_TOPOLOGY_LINE_LIST_WITH_ADJACENCY", pragma::math::to_integral(prosper::PrimitiveTopology::LineListWithAdjacency)},
	    {"PRIMITIVE_TOPOLOGY_LINE_STRIP_WITH_ADJACENCY", pragma::math::to_integral(prosper::PrimitiveTopology::LineStripWithAdjacency)}, {"PRIMITIVE_TOPOLOGY_TRIANGLE_LIST_WITH_ADJACENCY", pragma::math::to_integral(prosper::PrimitiveTopology::TriangleListWithAdjacency)},
	    {"PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP_WITH_ADJACENCY", pragma::math::to_integral(prosper::PrimitiveTopology::TriangleStripWithAdjacency)}, {"PRIMITIVE_TOPOLOGY_PATCH_LIST", pragma::math::to_integral(prosper::PrimitiveTopology::PatchList)},

	    {"SHARING_MODE_EXCLUSIVE", pragma::math::to_integral(prosper::SharingMode::Exclusive)}, {"SHARING_MODE_CONCURRENT", pragma::math::to_integral(prosper::SharingMode::Concurrent)},

	    {"INDEX_TYPE_UINT16", pragma::math::to_integral(prosper::IndexType::UInt16)}, {"INDEX_TYPE_UINT32", pragma::math::to_integral(prosper::IndexType::UInt32)},

	    {"FILTER_NEAREST", pragma::math::to_integral(prosper::Filter::Nearest)}, {"FILTER_LINEAR", pragma::math::to_integral(prosper::Filter::Linear)},

	    {"POLYGON_MODE_FILL", pragma::math::to_integral(prosper::PolygonMode::Fill)}, {"POLYGON_MODE_LINE", pragma::math::to_integral(prosper::PolygonMode::Line)}, {"POLYGON_MODE_POINT", pragma::math::to_integral(prosper::PolygonMode::Point)},

	    {"CULL_MODE_NONE", pragma::math::to_integral(prosper::CullModeFlags::None)}, {"CULL_MODE_FRONT_BIT", pragma::math::to_integral(prosper::CullModeFlags::FrontBit)}, {"CULL_MODE_BACK_BIT", pragma::math::to_integral(prosper::CullModeFlags::BackBit)},
	    {"CULL_MODE_FRONT_AND_BACK", pragma::math::to_integral(prosper::CullModeFlags::FrontAndBack)},

	    {"FRONT_FACE_COUNTER_CLOCKWISE", pragma::math::to_integral(prosper::FrontFace::CounterClockwise)}, {"FRONT_FACE_CLOCKWISE", pragma::math::to_integral(prosper::FrontFace::Clockwise)},

	    {"BLEND_FACTOR_ZERO", pragma::math::to_integral(prosper::BlendFactor::Zero)}, {"BLEND_FACTOR_ONE", pragma::math::to_integral(prosper::BlendFactor::One)}, {"BLEND_FACTOR_SRC_COLOR", pragma::math::to_integral(prosper::BlendFactor::SrcColor)},
	    {"BLEND_FACTOR_ONE_MINUS_SRC_COLOR", pragma::math::to_integral(prosper::BlendFactor::OneMinusSrcColor)}, {"BLEND_FACTOR_DST_COLOR", pragma::math::to_integral(prosper::BlendFactor::DstColor)}, {"BLEND_FACTOR_ONE_MINUS_DST_COLOR", pragma::math::to_integral(prosper::BlendFactor::OneMinusDstColor)},
	    {"BLEND_FACTOR_SRC_ALPHA", pragma::math::to_integral(prosper::BlendFactor::SrcAlpha)}, {"BLEND_FACTOR_ONE_MINUS_SRC_ALPHA", pragma::math::to_integral(prosper::BlendFactor::OneMinusSrcAlpha)}, {"BLEND_FACTOR_DST_ALPHA", pragma::math::to_integral(prosper::BlendFactor::DstAlpha)},
	    {"BLEND_FACTOR_ONE_MINUS_DST_ALPHA", pragma::math::to_integral(prosper::BlendFactor::OneMinusDstAlpha)}, {"BLEND_FACTOR_CONSTANT_COLOR", pragma::math::to_integral(prosper::BlendFactor::ConstantColor)},
	    {"BLEND_FACTOR_ONE_MINUS_CONSTANT_COLOR", pragma::math::to_integral(prosper::BlendFactor::OneMinusConstantColor)}, {"BLEND_FACTOR_CONSTANT_ALPHA", pragma::math::to_integral(prosper::BlendFactor::ConstantAlpha)},
	    {"BLEND_FACTOR_ONE_MINUS_CONSTANT_ALPHA", pragma::math::to_integral(prosper::BlendFactor::OneMinusConstantAlpha)}, {"BLEND_FACTOR_SRC_ALPHA_SATURATE", pragma::math::to_integral(prosper::BlendFactor::SrcAlphaSaturate)},
	    {"BLEND_FACTOR_SRC1_COLOR", pragma::math::to_integral(prosper::BlendFactor::Src1Color)}, {"BLEND_FACTOR_ONE_MINUS_SRC1_COLOR", pragma::math::to_integral(prosper::BlendFactor::OneMinusSrc1Color)}, {"BLEND_FACTOR_SRC1_ALPHA", pragma::math::to_integral(prosper::BlendFactor::Src1Alpha)},
	    {"BLEND_FACTOR_ONE_MINUS_SRC1_ALPHA", pragma::math::to_integral(prosper::BlendFactor::OneMinusSrc1Alpha)},

	    {"BLEND_OP_ADD", pragma::math::to_integral(prosper::BlendOp::Add)}, {"BLEND_OP_SUBTRACT", pragma::math::to_integral(prosper::BlendOp::Subtract)}, {"BLEND_OP_REVERSE_SUBTRACT", pragma::math::to_integral(prosper::BlendOp::ReverseSubtract)}, {"BLEND_OP_MIN", pragma::math::to_integral(prosper::BlendOp::Min)},
	    {"BLEND_OP_MAX", pragma::math::to_integral(prosper::BlendOp::Max)},

	    {"STENCIL_OP_KEEP", pragma::math::to_integral(prosper::StencilOp::Keep)}, {"STENCIL_OP_ZERO", pragma::math::to_integral(prosper::StencilOp::Zero)}, {"STENCIL_OP_REPLACE", pragma::math::to_integral(prosper::StencilOp::Replace)},
	    {"STENCIL_OP_INCREMENT_AND_CLAMP", pragma::math::to_integral(prosper::StencilOp::IncrementAndClamp)}, {"STENCIL_OP_DECREMENT_AND_CLAMP", pragma::math::to_integral(prosper::StencilOp::DecrementAndClamp)}, {"STENCIL_OP_INVERT", pragma::math::to_integral(prosper::StencilOp::Invert)},
	    {"STENCIL_OP_INCREMENT_AND_WRAP", pragma::math::to_integral(prosper::StencilOp::IncrementAndWrap)}, {"STENCIL_OP_DECREMENT_AND_WRAP", pragma::math::to_integral(prosper::StencilOp::DecrementAndWrap)},

	    {"LOGIC_OP_CLEAR", pragma::math::to_integral(prosper::LogicOp::Clear)}, {"LOGIC_OP_AND", pragma::math::to_integral(prosper::LogicOp::And)}, {"LOGIC_OP_AND_REVERSE", pragma::math::to_integral(prosper::LogicOp::AndReverse)}, {"LOGIC_OP_COPY", pragma::math::to_integral(prosper::LogicOp::Copy)},
	    {"LOGIC_OP_AND_INVERTED", pragma::math::to_integral(prosper::LogicOp::AndInverted)}, {"LOGIC_OP_NO_OP", pragma::math::to_integral(prosper::LogicOp::NoOp)}, {"LOGIC_OP_XOR", pragma::math::to_integral(prosper::LogicOp::Xor)}, {"LOGIC_OP_OR", pragma::math::to_integral(prosper::LogicOp::Or)},
	    {"LOGIC_OP_NOR", pragma::math::to_integral(prosper::LogicOp::Nor)}, {"LOGIC_OP_EQUIVALENT", pragma::math::to_integral(prosper::LogicOp::Equivalent)}, {"LOGIC_OP_INVERT", pragma::math::to_integral(prosper::LogicOp::Invert)}, {"LOGIC_OP_OR_REVERSE", pragma::math::to_integral(prosper::LogicOp::OrReverse)},
	    {"LOGIC_OP_COPY_INVERTED", pragma::math::to_integral(prosper::LogicOp::CopyInverted)}, {"LOGIC_OP_OR_INVERTED", pragma::math::to_integral(prosper::LogicOp::OrInverted)}, {"LOGIC_OP_NAND", pragma::math::to_integral(prosper::LogicOp::Nand)}, {"LOGIC_OP_SET", pragma::math::to_integral(prosper::LogicOp::Set)},

	    {"PHYSICAL_DEVICE_TYPE_OTHER", pragma::math::to_integral(prosper::PhysicalDeviceType::Other)}, {"PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU", pragma::math::to_integral(prosper::PhysicalDeviceType::IntegratedGPU)},
	    {"PHYSICAL_DEVICE_TYPE_DISCRETE_GPU", pragma::math::to_integral(prosper::PhysicalDeviceType::DiscreteGPU)}, {"PHYSICAL_DEVICE_TYPE_VIRTUAL_GPU", pragma::math::to_integral(prosper::PhysicalDeviceType::VirtualGPU)},
	    {"PHYSICAL_DEVICE_TYPE_CPU", pragma::math::to_integral(prosper::PhysicalDeviceType::CPU)},

	    {"VERTEX_INPUT_RATE_VERTEX", pragma::math::to_integral(prosper::VertexInputRate::Vertex)}, {"VERTEX_INPUT_RATE_INSTANCE", pragma::math::to_integral(prosper::VertexInputRate::Instance)},

	    {"DYNAMIC_STATE_NONE", pragma::math::to_integral(prosper::util::DynamicStateFlags::None)}, {"DYNAMIC_STATE_VIEWPORT_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::Viewport)}, {"DYNAMIC_STATE_SCISSOR_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::Scissor)},
	    {"DYNAMIC_STATE_LINE_WIDTH_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::LineWidth)}, {"DYNAMIC_STATE_DEPTH_BIAS_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::DepthBias)},
	    {"DYNAMIC_STATE_BLEND_CONSTANTS_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::BlendConstants)}, {"DYNAMIC_STATE_DEPTH_BOUNDS_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::DepthBounds)},
	    {"DYNAMIC_STATE_STENCIL_COMPARE_MASK_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::StencilCompareMask)}, {"DYNAMIC_STATE_STENCIL_WRITE_MASK_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::StencilWriteMask)},
	    {"DYNAMIC_STATE_STENCIL_REFERENCE_BIT", pragma::math::to_integral(prosper::util::DynamicStateFlags::StencilReference)},
#if 0
	    ...
	    {"MEMORY_PROPERTY_DEVICE_LOCAL_BIT", pragma::math::to_integral(prosper::MemoryPropertyFlags::DeviceLocalBit)}, {"MEMORY_PROPERTY_HOST_VISIBLE_BIT", pragma::math::to_integral(prosper::MemoryPropertyFlags::HostVisibleBit)},
	    {"MEMORY_PROPERTY_HOST_COHERENT_BIT", pragma::math::to_integral(prosper::MemoryPropertyFlags::HostCoherentBit)}, {"MEMORY_PROPERTY_HOST_CACHED_BIT", pragma::math::to_integral(prosper::MemoryPropertyFlags::HostCachedBit)},
	    {"MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT", pragma::math::to_integral(prosper::MemoryPropertyFlags::LazilyAllocatedBit)},

	    {"ACCESS_INDIRECT_COMMAND_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::IndirectCommandReadBit)}, {"ACCESS_INDEX_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::IndexReadBit)},
	    {"ACCESS_VERTEX_ATTRIBUTE_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::VertexAttributeReadBit)}, {"ACCESS_UNIFORM_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::UniformReadBit)},
	    {"ACCESS_INPUT_ATTACHMENT_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::InputAttachmentReadBit)}, {"ACCESS_SHADER_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::ShaderReadBit)}, {"ACCESS_SHADER_WRITE_BIT", pragma::math::to_integral(prosper::AccessFlags::ShaderWriteBit)},
	    {"ACCESS_COLOR_ATTACHMENT_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::ColorAttachmentReadBit)}, {"ACCESS_COLOR_ATTACHMENT_WRITE_BIT", pragma::math::to_integral(prosper::AccessFlags::ColorAttachmentWriteBit)},
	    {"ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::DepthStencilAttachmentReadBit)}, {"ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT", pragma::math::to_integral(prosper::AccessFlags::DepthStencilAttachmentWriteBit)},
	    {"ACCESS_TRANSFER_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::TransferReadBit)}, {"ACCESS_TRANSFER_WRITE_BIT", pragma::math::to_integral(prosper::AccessFlags::TransferWriteBit)}, {"ACCESS_HOST_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::HostReadBit)},
	    {"ACCESS_HOST_WRITE_BIT", pragma::math::to_integral(prosper::AccessFlags::HostWriteBit)}, {"ACCESS_MEMORY_READ_BIT", pragma::math::to_integral(prosper::AccessFlags::MemoryReadBit)}, {"ACCESS_MEMORY_WRITE_BIT", pragma::math::to_integral(prosper::AccessFlags::MemoryWriteBit)},

	    {"BUFFER_USAGE_TRANSFER_SRC_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::TransferSrcBit)}, {"BUFFER_USAGE_TRANSFER_DST_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::TransferDstBit)},
	    {"BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::UniformTexelBufferBit)}, {"BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::StorageTexelBufferBit)},
	    {"BUFFER_USAGE_UNIFORM_BUFFER_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::UniformBufferBit)}, {"BUFFER_USAGE_STORAGE_BUFFER_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::StorageBufferBit)},
	    {"BUFFER_USAGE_INDEX_BUFFER_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::IndexBufferBit)}, {"BUFFER_USAGE_VERTEX_BUFFER_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::VertexBufferBit)},
	    {"BUFFER_USAGE_INDIRECT_BUFFER_BIT", pragma::math::to_integral(prosper::BufferUsageFlags::IndirectBufferBit)},

	    {"SHADER_STAGE_VERTEX_BIT", pragma::math::to_integral(prosper::ShaderStageFlags::VertexBit)}, {"SHADER_STAGE_TESSELLATION_CONTROL_BIT", pragma::math::to_integral(prosper::ShaderStageFlags::TessellationControlBit)},
	    {"SHADER_STAGE_TESSELLATION_EVALUATION_BIT", pragma::math::to_integral(prosper::ShaderStageFlags::TessellationEvaluationBit)}, {"SHADER_STAGE_GEOMETRY_BIT", pragma::math::to_integral(prosper::ShaderStageFlags::GeometryBit)},
	    {"SHADER_STAGE_FRAGMENT_BIT", pragma::math::to_integral(prosper::ShaderStageFlags::FragmentBit)}, {"SHADER_STAGE_COMPUTE_BIT", pragma::math::to_integral(prosper::ShaderStageFlags::ComputeBit)}, {"SHADER_STAGE_ALL_GRAPHICS", pragma::math::to_integral(prosper::ShaderStageFlags::AllGraphics)},
	    {"SHADER_STAGE_ALL", pragma::math::to_integral(prosper::ShaderStageFlags::All)},

	    {"IMAGE_USAGE_TRANSFER_SRC_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::TransferSrcBit)}, {"IMAGE_USAGE_TRANSFER_DST_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::TransferDstBit)}, {"IMAGE_USAGE_SAMPLED_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::SampledBit)},
	    {"IMAGE_USAGE_STORAGE_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::StorageBit)}, {"IMAGE_USAGE_COLOR_ATTACHMENT_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::ColorAttachmentBit)},
	    {"IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::DepthStencilAttachmentBit)}, {"IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::TransientAttachmentBit)},
	    {"IMAGE_USAGE_INPUT_ATTACHMENT_BIT", pragma::math::to_integral(prosper::ImageUsageFlags::InputAttachmentBit)},

	    {"IMAGE_CREATE_SPARSE_BINDING_BIT", pragma::math::to_integral(prosper::ImageCreateFlags::SparseBindingBit)}, {"IMAGE_CREATE_SPARSE_RESIDENCY_BIT", pragma::math::to_integral(prosper::ImageCreateFlags::SparseResidencyBit)},
	    {"IMAGE_CREATE_SPARSE_ALIASED_BIT", pragma::math::to_integral(prosper::ImageCreateFlags::SparseAliasedBit)}, {"IMAGE_CREATE_MUTABLE_FORMAT_BIT", pragma::math::to_integral(prosper::ImageCreateFlags::MutableFormatBit)},
	    {"IMAGE_CREATE_CUBE_COMPATIBLE_BIT", pragma::math::to_integral(prosper::ImageCreateFlags::CubeCompatibleBit)},

	    {"PIPELINE_CREATE_DISABLE_OPTIMIZATION_BIT", pragma::math::to_integral(prosper::PipelineCreateFlags::DisableOptimizationBit)}, {"PIPELINE_CREATE_ALLOW_DERIVATIVES_BIT", pragma::math::to_integral(prosper::PipelineCreateFlags::AllowDerivativesBit)},
	    {"PIPELINE_CREATE_DERIVATIVE_BIT", pragma::math::to_integral(prosper::PipelineCreateFlags::DerivativeBit)},

	    {"COLOR_COMPONENT_R_BIT", pragma::math::to_integral(prosper::ColorComponentFlags::RBit)}, {"COLOR_COMPONENT_G_BIT", pragma::math::to_integral(prosper::ColorComponentFlags::GBit)}, {"COLOR_COMPONENT_B_BIT", pragma::math::to_integral(prosper::ColorComponentFlags::BBit)},
	    {"COLOR_COMPONENT_A_BIT", pragma::math::to_integral(prosper::ColorComponentFlags::ABit)},

	    {"QUERY_RESULT_64_BIT", pragma::math::to_integral(prosper::QueryResultFlags::e64Bit)}, {"QUERY_RESULT_WAIT_BIT", pragma::math::to_integral(prosper::QueryResultFlags::WaitBit)}, {"QUERY_RESULT_WITH_AVAILABILITY_BIT", pragma::math::to_integral(prosper::QueryResultFlags::WithAvailabilityBit)},
	    {"QUERY_RESULT_PARTIAL_BIT", pragma::math::to_integral(prosper::QueryResultFlags::PartialBit)},

	    {"QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_VERTICES_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::InputAssemblyVerticesBit)},
	    {"QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_PRIMITIVES_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::InputAssemblyPrimitivesBit)},
	    {"QUERY_PIPELINE_STATISTIC_VERTEX_SHADER_INVOCATIONS_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::VertexShaderInvocationsBit)},
	    {"QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_INVOCATIONS_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::GeometryShaderInvocationsBit)},
	    {"QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_PRIMITIVES_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::GeometryShaderPrimitivesBit)},
	    {"QUERY_PIPELINE_STATISTIC_CLIPPING_INVOCATIONS_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::ClippingInvocationsBit)}, {"QUERY_PIPELINE_STATISTIC_CLIPPING_PRIMITIVES_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::ClippingPrimitivesBit)},
	    {"QUERY_PIPELINE_STATISTIC_FRAGMENT_SHADER_INVOCATIONS_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::FragmentShaderInvocationsBit)},
	    {"QUERY_PIPELINE_STATISTIC_TESSELLATION_CONTROL_SHADER_PATCHES_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::TessellationControlShaderPatchesBit)},
	    {"QUERY_PIPELINE_STATISTIC_TESSELLATION_EVALUATION_SHADER_INVOCATIONS_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::TessellationEvaluationShaderInvocationsBit)},
	    {"QUERY_PIPELINE_STATISTIC_COMPUTE_SHADER_INVOCATIONS_BIT", pragma::math::to_integral(prosper::QueryPipelineStatisticFlags::ComputeShaderInvocationsBit)},

	    {"IMAGE_ASPECT_COLOR_BIT", pragma::math::to_integral(prosper::ImageAspectFlags::ColorBit)}, {"IMAGE_ASPECT_DEPTH_BIT", pragma::math::to_integral(prosper::ImageAspectFlags::DepthBit)}, {"IMAGE_ASPECT_STENCIL_BIT", pragma::math::to_integral(prosper::ImageAspectFlags::StencilBit)},
	    {"IMAGE_ASPECT_METADATA_BIT", pragma::math::to_integral(prosper::ImageAspectFlags::MetadataBit)},

	    {"PIPELINE_STAGE_TOP_OF_PIPE_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::TopOfPipeBit)}, {"PIPELINE_STAGE_DRAW_INDIRECT_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::DrawIndirectBit)},
	    {"PIPELINE_STAGE_VERTEX_INPUT_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::VertexInputBit)}, {"PIPELINE_STAGE_VERTEX_SHADER_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::VertexShaderBit)},
	    {"PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::TessellationControlShaderBit)}, {"PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::TessellationEvaluationShaderBit)},
	    {"PIPELINE_STAGE_GEOMETRY_SHADER_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::GeometryShaderBit)}, {"PIPELINE_STAGE_FRAGMENT_SHADER_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::FragmentShaderBit)},
	    {"PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::EarlyFragmentTestsBit)}, {"PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::LateFragmentTestsBit)},
	    {"PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::ColorAttachmentOutputBit)}, {"PIPELINE_STAGE_COMPUTE_SHADER_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::ComputeShaderBit)},
	    {"PIPELINE_STAGE_TRANSFER_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::TransferBit)}, {"PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::BottomOfPipeBit)},
	    {"PIPELINE_STAGE_HOST_BIT", pragma::math::to_integral(prosper::PipelineStageFlags::HostBit)}, {"PIPELINE_STAGE_ALL_GRAPHICS", pragma::math::to_integral(prosper::PipelineStageFlags::AllGraphics)}, {"PIPELINE_STAGE_ALL_COMMANDS", pragma::math::to_integral(prosper::PipelineStageFlags::AllCommands)},

	    {"SAMPLE_COUNT_1_BIT", pragma::math::to_integral(prosper::SampleCountFlags::e1Bit)}, {"SAMPLE_COUNT_2_BIT", pragma::math::to_integral(prosper::SampleCountFlags::e2Bit)}, {"SAMPLE_COUNT_4_BIT", pragma::math::to_integral(prosper::SampleCountFlags::e4Bit)},
	    {"SAMPLE_COUNT_8_BIT", pragma::math::to_integral(prosper::SampleCountFlags::e8Bit)}, {"SAMPLE_COUNT_16_BIT", pragma::math::to_integral(prosper::SampleCountFlags::e16Bit)}, {"SAMPLE_COUNT_32_BIT", pragma::math::to_integral(prosper::SampleCountFlags::e32Bit)},
	    {"SAMPLE_COUNT_64_BIT", pragma::math::to_integral(prosper::SampleCountFlags::e64Bit)},

	    {"STENCIL_FACE_FRONT_BIT", pragma::math::to_integral(prosper::StencilFaceFlags::FrontBit)}, {"STENCIL_FACE_BACK_BIT", pragma::math::to_integral(prosper::StencilFaceFlags::BackBit)}, {"STENCIL_FRONT_AND_BACK", pragma::math::to_integral(prosper::StencilFaceFlags::FrontAndBack)},

	    {"PRESENT_MODE_IMMEDIATE_KHR", pragma::math::to_integral(prosper::PresentModeKHR::Immediate)}, {"PRESENT_MODE_MAILBOX_KHR", pragma::math::to_integral(prosper::PresentModeKHR::Mailbox)}, {"PRESENT_MODE_FIFO_KHR", pragma::math::to_integral(prosper::PresentModeKHR::Fifo)},
	    {"PRESENT_MODE_FIFO_RELAXED_KHR", pragma::math::to_integral(prosper::PresentModeKHR::FifoRelaxed)},
	    ...
	    {"DEBUG_REPORT_INFORMATION_BIT_EXT", pragma::math::to_integral(prosper::DebugReportFlags::InformationBit)}, {"DEBUG_REPORT_WARNING_BIT_EXT", pragma::math::to_integral(prosper::DebugReportFlags::WarningBit)},
	    {"DEBUG_REPORT_PERFORMANCE_WARNING_BIT_EXT", pragma::math::to_integral(prosper::DebugReportFlags::PerformanceWarningBit)}, {"DEBUG_REPORT_ERROR_BIT_EXT", pragma::math::to_integral(prosper::DebugReportFlags::ErrorBit)},
	    {"DEBUG_REPORT_DEBUG_BIT_EXT", pragma::math::to_integral(prosper::DebugReportFlags::DebugBit)},

	    {"DEBUG_REPORT_OBJECT_TYPE_UNKNOWN_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Unknown)}, {"DEBUG_REPORT_OBJECT_TYPE_INSTANCE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Instance)},
	    {"DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::PhysicalDevice)}, {"DEBUG_REPORT_OBJECT_TYPE_DEVICE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Device)},
	    {"DEBUG_REPORT_OBJECT_TYPE_QUEUE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Queue)}, {"DEBUG_REPORT_OBJECT_TYPE_SEMAPHORE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Semaphore)},
	    {"DEBUG_REPORT_OBJECT_TYPE_COMMAND_BUFFER_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::CommandBuffer)}, {"DEBUG_REPORT_OBJECT_TYPE_FENCE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Fence)},
	    {"DEBUG_REPORT_OBJECT_TYPE_DEVICE_MEMORY_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::DeviceMemory)}, {"DEBUG_REPORT_OBJECT_TYPE_BUFFER_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Buffer)},
	    {"DEBUG_REPORT_OBJECT_TYPE_IMAGE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Image)}, {"DEBUG_REPORT_OBJECT_TYPE_EVENT_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Event)},
	    {"DEBUG_REPORT_OBJECT_TYPE_QUERY_POOL_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::QueryPool)}, {"DEBUG_REPORT_OBJECT_TYPE_BUFFER_VIEW_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::BufferView)},
	    {"DEBUG_REPORT_OBJECT_TYPE_IMAGE_VIEW_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::ImageView)}, {"DEBUG_REPORT_OBJECT_TYPE_SHADER_MODULE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::ShaderModule)},
	    {"DEBUG_REPORT_OBJECT_TYPE_PIPELINE_CACHE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::PipelineCache)}, {"DEBUG_REPORT_OBJECT_TYPE_PIPELINE_LAYOUT_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::PipelineLayout)},
	    {"DEBUG_REPORT_OBJECT_TYPE_RENDER_PASS_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::RenderPass)}, {"DEBUG_REPORT_OBJECT_TYPE_PIPELINE_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Pipeline)},
	    {"DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::DescriptorSetLayout)}, {"DEBUG_REPORT_OBJECT_TYPE_SAMPLER_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Sampler)},
	    {"DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_POOL_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::DescriptorPool)}, {"DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_SET_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::DescriptorSet)},
	    {"DEBUG_REPORT_OBJECT_TYPE_FRAMEBUFFER_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::Framebuffer)}, {"DEBUG_REPORT_OBJECT_TYPE_COMMAND_POOL_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::CommandPool)},
	    {"DEBUG_REPORT_OBJECT_TYPE_SURFACE_KHR_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::SurfaceKHR)}, {"DEBUG_REPORT_OBJECT_TYPE_SWAPCHAIN_KHR_EXT", pragma::math::to_integral(prosper::DebugReportObjectTypeEXT::SwapchainKHR)},

	    {"MEMORY_FEATURE_DEVICE_LOCAL_BIT", pragma::math::to_integral(prosper::MemoryFeatureFlags::DeviceLocal)}, {"MEMORY_FEATURE_HOST_CACHED_BIT", pragma::math::to_integral(prosper::MemoryFeatureFlags::HostCached)},
	    {"MEMORY_FEATURE_HOST_COHERENT_BIT", pragma::math::to_integral(prosper::MemoryFeatureFlags::HostCoherent)}, {"MEMORY_FEATURE_LAZILY_ALLOCATED_BIT", pragma::math::to_integral(prosper::MemoryFeatureFlags::LazilyAllocated)},
	    {"MEMORY_FEATURE_HOST_ACCESSABLE_BIT", pragma::math::to_integral(prosper::MemoryFeatureFlags::HostAccessable)}, {"MEMORY_FEATURE_GPU_BULK_BIT", pragma::math::to_integral(prosper::MemoryFeatureFlags::GPUBulk)},
	    {"MEMORY_FEATURE_CPU_TO_GPU", pragma::math::to_integral(prosper::MemoryFeatureFlags::CPUToGPU)}, {"MEMORY_FEATURE_GPU_TO_CPU", pragma::math::to_integral(prosper::MemoryFeatureFlags::GPUToCPU)},

	    {"QUEUE_FAMILY_GRAPHICS_BIT", pragma::math::to_integral(prosper::QueueFamilyFlags::GraphicsBit)}, {"QUEUE_FAMILY_COMPUTE_BIT", pragma::math::to_integral(prosper::QueueFamilyFlags::ComputeBit)}, {"QUEUE_FAMILY_DMA_BIT", pragma::math::to_integral(prosper::QueueFamilyFlags::DMABit)}});
	...
	defBufferCreateInfo.add_static_constant("FLAG_NONE", pragma::math::to_integral(prosper::util::BufferCreateInfo::Flags::None));
	defBufferCreateInfo.add_static_constant("FLAG_CONCURRENT_SHARING_BIT", pragma::math::to_integral(prosper::util::BufferCreateInfo::Flags::ConcurrentSharing));
	defBufferCreateInfo.add_static_constant("FLAG_DONT_ALLOCATE_MEMORY_BIT", pragma::math::to_integral(prosper::util::BufferCreateInfo::Flags::DontAllocateMemory));
	defBufferCreateInfo.add_static_constant("FLAG_SPARSE_BIT", pragma::math::to_integral(prosper::util::BufferCreateInfo::Flags::Sparse));
	defBufferCreateInfo.add_static_constant("FLAG_SPARSE_ALIASED_RESIDENCY_BIT", pragma::math::to_integral(prosper::util::BufferCreateInfo::Flags::SparseAliasedResidency));
	...
	defTextureCreateInfo.add_static_constant("FLAG_NONE", pragma::math::to_integral(prosper::util::TextureCreateInfo::Flags::None));
	defTextureCreateInfo.add_static_constant("FLAG_RESOLVABLE", pragma::math::to_integral(prosper::util::TextureCreateInfo::Flags::Resolvable));
	defTextureCreateInfo.add_static_constant("FLAG_CREATE_IMAGE_VIEW_FOR_EACH_LAYER", pragma::math::to_integral(prosper::util::TextureCreateInfo::Flags::CreateImageViewForEachLayer));
	...
	defImageCreateInfo.add_static_constant("FLAG_NONE", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::None));
	defImageCreateInfo.add_static_constant("FLAG_CUBEMAP_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::Cubemap));
	defImageCreateInfo.add_static_constant("FLAG_CONCURRENT_SHARING_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::ConcurrentSharing));
	defImageCreateInfo.add_static_constant("FLAG_FULL_MIPMAP_CHAIN_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::FullMipmapChain));
	defImageCreateInfo.add_static_constant("FLAG_SPARSE_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::Sparse));
	defImageCreateInfo.add_static_constant("FLAG_SPARSE_ALIASED_RESIDENCY_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::SparseAliasedResidency));

	defImageCreateInfo.add_static_constant("FLAG_ALLOCATE_DISCRETE_MEMORY_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::AllocateDiscreteMemory));
	defImageCreateInfo.add_static_constant("FLAG_DONT_ALLOCATE_MEMORY_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::DontAllocateMemory));
	defImageCreateInfo.add_static_constant("FLAG_SRGB_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::Srgb));
	defImageCreateInfo.add_static_constant("FLAG_NORMAL_MAP_BIT", pragma::math::to_integral(prosper::util::ImageCreateInfo::Flags::NormalMap));
	...
	auto defToImageBufferInfo = luabind::class_<pragma::util::ToImageBufferInfo>("ToImageBufferInfo");
	defToImageBufferInfo.def(luabind::constructor<>());
	defToImageBufferInfo.def_readwrite("includeLayers", &pragma::util::ToImageBufferInfo::includeLayers);
	defToImageBufferInfo.def_readwrite("includeMipmaps", &pragma::util::ToImageBufferInfo::includeMipmaps);
	defToImageBufferInfo.def_readwrite("inputImageLayout", &pragma::util::ToImageBufferInfo::inputImageLayout);
	defToImageBufferInfo.def_readwrite("finalImageLayout", &pragma::util::ToImageBufferInfo::finalImageLayout);
	defToImageBufferInfo.def_readwrite("stagingImage", &pragma::util::ToImageBufferInfo::stagingImage);
	defToImageBufferInfo.def_readwrite("targetFormat", &pragma::util::ToImageBufferInfo::targetFormat);
	...
	defMonitor.def(
	  "GetVideoMode", +[](lua::State *l, const pragma::platform::Monitor &monitor) -> Lua::map<std::string, int> {
