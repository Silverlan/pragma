...
void Lua::Vulkan::VKMemory::Write(lua_State *l,Memory &hMemory,uint32_t offset,::util::DataStream &ds,uint32_t dsOffset,uint32_t dsSize)
{
...
void Lua::Vulkan::VKMemory::Read(lua_State *l,Memory &hMemory,uint32_t offset,uint32_t size,::util::DataStream &ds,uint32_t dsOffset)
{
...
bool Lua::Vulkan::VKCommandBuffer::RecordUpdateBuffer(lua_State *l, CommandBuffer &hCommandBuffer, Buffer &buf, uint32_t offset, ::util::DataStream &ds) { return hCommandBuffer.RecordUpdateBuffer(buf, offset, ds->GetSize(), ds->GetData()); }
...
bool Lua::Vulkan::VKBuffer::Write(lua_State *l, Buffer &hBuffer, uint32_t offset, ::util::DataStream &ds, uint32_t dsOffset, uint32_t dsSize) { return hBuffer.Write(offset, dsSize, ds->GetData() + dsOffset); }
...
Lua::opt<::util::DataStream> Lua::Vulkan::VKBuffer::Read(lua_State *l, Buffer &hBuffer, uint32_t offset, uint32_t size)
{
	auto ds = ::util::DataStream(size);
...
bool Lua::Vulkan::VKBuffer::Read(lua_State *l, Buffer &hBuffer, uint32_t offset, uint32_t size, ::util::DataStream &ds, uint32_t dsOffset)
{
