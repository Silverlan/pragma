...
pragma::rendering::VertexBufferData::VertexBufferData(const umath::Vertex &vertex) : VertexBufferData {vertex.position, vertex.uv, vertex.normal, Vector3 {vertex.tangent}, vertex.GetBiTangent()} {}
