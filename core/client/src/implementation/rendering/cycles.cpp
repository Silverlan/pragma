...
struct CyclesModuleInterface {
	...
	void (*render_image)(const pragma::rendering::cycles::SceneInfo &sceneInfo, const pragma::rendering::cycles::RenderImageInfo &renderImageInfo, const std::function<bool(pragma::ecs::BaseEntity &)> &entFilter, pragma::util::ParallelJob<uimg::ImageLayerSet> &outJob) = nullptr;

	void (*bake_ao)(const pragma::rendering::cycles::SceneInfo &sceneInfo, pragma::asset::Model &mdl, uint32_t materialIndex, pragma::util::ParallelJob<uimg::ImageLayerSet> &outJob) = nullptr;
	void (*bake_ao_ent)(const pragma::rendering::cycles::SceneInfo &sceneInfo, pragma::ecs::BaseEntity &ent, uint32_t materialIndex, pragma::util::ParallelJob<uimg::ImageLayerSet> &outJob) = nullptr;
	void (*bake_lightmaps)(const pragma::rendering::cycles::SceneInfo &sceneInfo, pragma::util::ParallelJob<uimg::ImageLayerSet> &outJob) = nullptr;
...
pragma::util::ParallelJob<uimg::ImageLayerSet> cycles::render_image(pragma::ClientState &client, const SceneInfo &sceneInfo, const RenderImageInfo &renderImageInfo)
{
...
pragma::util::ParallelJob<uimg::ImageLayerSet> cycles::bake_ambient_occlusion(pragma::ClientState &client, const SceneInfo &sceneInfo, pragma::ecs::BaseEntity &ent, uint32_t materialIndex)
{
	auto cyclesInterface = initialize_library(client);
	if(cyclesInterface.has_value() == false)
		return {};
...
pragma::util::ParallelJob<uimg::ImageLayerSet> cycles::bake_ambient_occlusion(pragma::ClientState &client, const SceneInfo &sceneInfo, pragma::asset::Model &mdl, uint32_t materialIndex)
{
	auto cyclesInterface = initialize_library(client);
	if(cyclesInterface.has_value() == false)
		return {};
...
pragma::util::ParallelJob<uimg::ImageLayerSet> cycles::bake_lightmaps(pragma::ClientState &client, const SceneInfo &sceneInfo)
{
	auto cyclesInterface = initialize_library(client);
	if(cyclesInterface.has_value() == false)
		return {};
