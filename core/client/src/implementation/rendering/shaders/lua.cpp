...
pragma::LShaderGui::LShaderGui() : TLShaderBase<pragma::gui::shaders::Shader>(pragma::get_cengine()->GetRenderContext(), "", "", "") { SetPipelineCount(pragma::math::to_integral(pragma::gui::StencilPipeline::Count) * 2); }
