...
decltype(ShaderScene::DESCRIPTOR_SET_RENDERER) ShaderScene::DESCRIPTOR_SET_RENDERER = {
  ...
  {prosper::DescriptorSetInfo::Binding {"RENDERER", prosper::DescriptorType::UniformBuffer, prosper::ShaderStageFlags::FragmentBit}, prosper::DescriptorSetInfo::Binding {"SSAO_MAP", prosper::DescriptorType::CombinedImageSampler, prosper::ShaderStageFlags::FragmentBit},
    ...
    prosper::DescriptorSetInfo::Binding {"SHADOW_BUFFERS", SHADOW_BUFFER_TYPE, prosper::ShaderStageFlags::FragmentBit},
...
decltype(ShaderEntity::VERTEX_ATTRIBUTE_POSITION) ShaderEntity::VERTEX_ATTRIBUTE_POSITION = {VERTEX_BINDING_VERTEX, pragma::rendering::VERTEX_BUFER_DATA_POSITION_FORMAT};
decltype(ShaderEntity::VERTEX_ATTRIBUTE_UV) ShaderEntity::VERTEX_ATTRIBUTE_UV = {VERTEX_BINDING_VERTEX, pragma::rendering::VERTEX_BUFER_DATA_UV_FORMAT, offsetof(pragma::rendering::VertexBufferData, uv)};
decltype(ShaderEntity::VERTEX_ATTRIBUTE_NORMAL) ShaderEntity::VERTEX_ATTRIBUTE_NORMAL = {VERTEX_BINDING_VERTEX, pragma::rendering::VERTEX_BUFER_DATA_NORMAL_FORMAT, offsetof(pragma::rendering::VertexBufferData, normal)};
decltype(ShaderEntity::VERTEX_ATTRIBUTE_TANGENT) ShaderEntity::VERTEX_ATTRIBUTE_TANGENT = {VERTEX_BINDING_VERTEX, pragma::rendering::VERTEX_BUFER_DATA_TANGENT_FORMAT, offsetof(pragma::rendering::VertexBufferData, tangent)};
// decltype(ShaderEntity::VERTEX_ATTRIBUTE_BI_TANGENT) ShaderEntity::VERTEX_ATTRIBUTE_BI_TANGENT = {VERTEX_BINDING_VERTEX, pragma::rendering::VERTEX_BUFER_DATA_BI_TANGENT_FORMAT, offsetof(pragma::rendering::VertexBufferData, biTangent)};
