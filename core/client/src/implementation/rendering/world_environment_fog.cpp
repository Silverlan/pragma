...
{
	m_color = pragma::util::make_shared<pragma::util::ColorProperty>(colors::White);
	m_start = pragma::util::make_shared<pragma::util::FloatProperty>(0.f);
	m_end = pragma::util::make_shared<pragma::util::FloatProperty>(0.f);
	m_maxDensity = pragma::util::make_shared<pragma::util::FloatProperty>(0.f);
	m_type = pragma::util::make_shared<pragma::util::UInt8Property>(pragma::math::to_integral(pragma::util::FogType::Linear));
	m_bEnabled = pragma::util::make_shared<pragma::util::BoolProperty>(false);
}
...
void pragma::rendering::WorldEnvironment::Fog::SetType(pragma::util::FogType type) { *m_type = pragma::math::to_integral(type); }
pragma::util::FogType pragma::rendering::WorldEnvironment::Fog::GetType() const { return static_cast<pragma::util::FogType>(**m_type); }
...
{
	switch(GetType()) {
	case pragma::util::FogType::Exponential:
		return logf(1.f / 0.0019f) / GetMaxDensity();
	case pragma::util::FogType::Exponential2:
