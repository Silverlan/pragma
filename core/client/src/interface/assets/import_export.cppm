...
export namespace pragma::asset {
	...
	DLLCLIENT std::optional<MaterialTexturePaths> export_material(msys::Material &mat, ModelExportInfo::ImageFormat imageFormat, std::string &outErrMsg, std::string *optExportPath = nullptr, bool normalizeTextureNames = false);
