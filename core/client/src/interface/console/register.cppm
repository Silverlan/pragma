...
export namespace pragma::console {
	...
	namespace client {
		...
		DummyReturnValue register_toggle_command(const std::string &scmd, void (*fcIn)(NetworkState *, BasePlayerComponent *, std::vector<std::string> &, float), void (*fcOut)(NetworkState *, BasePlayerComponent *, std::vector<std::string> &, float),
		  ConVarFlags flags, const std::string &help = "");
		DummyReturnValue register_toggle_command(const std::string &scmd, void (*fcIn)(NetworkState *, BasePlayerComponent *, std::vector<std::string> &), void (*fcOut)(NetworkState *, BasePlayerComponent *, std::vector<std::string> &), ConVarFlags flags,
