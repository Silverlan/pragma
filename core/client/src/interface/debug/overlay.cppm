...
export namespace pragma::debug {
	...
	#pragma pack(pop)
		...
		std::shared_ptr<DebugRenderer::BaseObject> DrawPoint(const pragma::debug::DebugRenderInfo &renderInfo);
		std::shared_ptr<DebugRenderer::BaseObject> DrawLines(const std::vector<Vector3> &lines, const pragma::debug::DebugRenderInfo &renderInfo = {});
		std::shared_ptr<DebugRenderer::BaseObject> DrawLine(const Vector3 &start, const Vector3 &end, const pragma::debug::DebugRenderInfo &renderInfo = {});
		std::shared_ptr<DebugRenderer::BaseObject> DrawBox(const Vector3 &start, const Vector3 &end, const pragma::debug::DebugRenderInfo &renderInfo = {});
		std::shared_ptr<DebugRenderer::BaseObject> DrawText(const pragma::debug::DebugRenderInfo &renderInfo, const std::string &text, const Vector2 &worldSize);
		std::shared_ptr<DebugRenderer::BaseObject> DrawText(const pragma::debug::DebugRenderInfo &renderInfo, const std::string &text, float sizeScale);
		std::shared_ptr<DebugRenderer::BaseObject> DrawText(const pragma::debug::DebugRenderInfo &renderInfo, const std::string &text, const Vector2 &worldSize);
		std::shared_ptr<DebugRenderer::BaseObject> DrawMesh(const std::vector<Vector3> &verts, const pragma::debug::DebugRenderInfo &renderInfo = {});
		std::shared_ptr<DebugRenderer::BaseObject> DrawSphere(const pragma::debug::DebugRenderInfo &renderInfo, float radius, uint32_t recursionLevel = 1);
		std::shared_ptr<DebugRenderer::BaseObject> DrawTruncatedCone(const pragma::debug::DebugRenderInfo &renderInfo, float startRadius, const Vector3 &dir, float dist, float endRadius, uint32_t segmentCount = 12);
		std::shared_ptr<DebugRenderer::BaseObject> DrawCylinder(const pragma::debug::DebugRenderInfo &renderInfo, const Vector3 &dir, float dist, float radius, uint32_t segmentCount = 12);
		std::shared_ptr<DebugRenderer::BaseObject> DrawCylinder(const pragma::debug::DebugRenderInfo &renderInfo, float dist, float radius, uint32_t segmentCount = 12);
		std::shared_ptr<DebugRenderer::BaseObject> DrawCone(const pragma::debug::DebugRenderInfo &renderInfo, const Vector3 &dir, float dist, float angle, uint32_t segmentCount = 12);
