...
export namespace Lua {
	...
	namespace WIBase {
		...
		DLLCLIENT ::util::EventReply InjectMouseInput(lua::State *l, pragma::gui::types::WIBase &hPanel, const ::Vector2 &mousePos, int button, int action, int mods);
		DLLCLIENT ::util::EventReply InjectMouseInput(lua::State *l, pragma::gui::types::WIBase &hPanel, const ::Vector2 &mousePos, int button, int action);
		DLLCLIENT ::util::EventReply InjectMouseClick(lua::State *l, pragma::gui::types::WIBase &hPanel, const ::Vector2 &mousePos, int button, int mods);
		DLLCLIENT ::util::EventReply InjectMouseClick(lua::State *l, pragma::gui::types::WIBase &hPanel, const ::Vector2 &mousePos, int button);
		DLLCLIENT ::util::EventReply InjectKeyboardInput(lua::State *l, pragma::gui::types::WIBase &hPanel, int key, int action, int mods);
		DLLCLIENT ::util::EventReply InjectKeyboardInput(lua::State *l, pragma::gui::types::WIBase &hPanel, int key, int action);
		DLLCLIENT ::util::EventReply InjectKeyPress(lua::State *l, pragma::gui::types::WIBase &hPanel, int key, int mods);
		DLLCLIENT ::util::EventReply InjectKeyPress(lua::State *l, pragma::gui::types::WIBase &hPanel, int key);
		DLLCLIENT ::util::EventReply InjectCharInput(lua::State *l, pragma::gui::types::WIBase &hPanel, std::string c, uint32_t mods);
		DLLCLIENT ::util::EventReply InjectCharInput(lua::State *l, pragma::gui::types::WIBase &hPanel, std::string c);
		DLLCLIENT ::util::EventReply InjectScrollInput(lua::State *l, pragma::gui::types::WIBase &hPanel, const ::Vector2 &mousePos, const ::Vector2 &offset, bool offsetAsPixels);
		DLLCLIENT ::util::EventReply InjectScrollInput(lua::State *l, pragma::gui::types::WIBase &hPanel, const ::Vector2 &mousePos, const ::Vector2 &offset);
