...
export namespace luabind {
	...
	template<typename T, typename TConverter>
	template<class U>
	T luabind::shader_converter<T, TConverter>::to_cpp(lua::State *L, U u, int index)
	{
		return m_converter.to_cpp(L, u, index);
	}

	template<typename T, typename TConverter>
	void luabind::shader_converter<T, TConverter>::to_lua(lua::State *L, T x)
	{
	...
	template<typename T, typename TConverter>
	template<class U>
	int luabind::shader_converter<T, TConverter>::match(lua::State *L, U u, int index)
	{
