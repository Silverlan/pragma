...
export namespace pragma::asset {
	...
	public:
		...
		void AddMesh(const std::string &meshGroup, const std::shared_ptr<pragma::geometry::CModelMesh> &mesh);
		...
		bool GetVertexAnimationBufferFrameOffset(uint32_t vaIdx, pragma::geometry::CModelSubMesh &subMesh, uint32_t frameId, uint64_t &offset) const;
	protected:
