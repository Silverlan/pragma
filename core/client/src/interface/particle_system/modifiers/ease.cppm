...
CParticleModifierComponentEase::CParticleModifierComponentEase() : m_type {pragma::math::EaseType::Linear} {}
...
float CParticleModifierComponentEase::EaseIn(float t) const { return pragma::math::ease_in(t, m_type); }
float CParticleModifierComponentEase::EaseOut(float t) const { return pragma::math::ease_out(t, m_type); }
float CParticleModifierComponentEase::EaseInOut(float t) const { return pragma::math::ease_in_out(t, m_type); }
