...
void pragma::pts::CParticleOperatorWander::OnParticleCreated(pragma::pts::CParticle &particle) { m_hashCodes.at(particle.GetIndex()) = umath::random(1, std::numeric_limits<int32_t>::max()); }
