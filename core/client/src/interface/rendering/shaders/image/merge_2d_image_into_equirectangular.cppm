...
#pragma pack(pop)
		...
		bool RecordDraw(prosper::ICommandBuffer &cmd, prosper::IDescriptorSet &descSetTextureEquirect, prosper::IDescriptorSet &descSetTexture2d, CubeFace cubeFace = CubeFace::PositiveX, pragma::math::Degree range = 360.f);
	  protected:
