...
std::string pragma::networking::StandardClient::GetIdentifier() const
{
	return m_clientConnection->GetLocalAddress().ToString();
}
...
bool pragma::networking::StandardClient::IsRunning() const
{
	return m_clientConnection != nullptr;
}
bool pragma::networking::StandardClient::IsDisconnected() const
{
	return m_clientConnection->IsDisconnected();
}
...
uint16_t pragma::networking::StandardClient::GetLatency() const
{
	return m_clientConnection->GetLatency();
}
void pragma::networking::StandardClient::SetTimeoutDuration(float duration)
{
...
std::optional<pragma::networking::Port> pragma::networking::StandardClient::GetLocalTCPPort() const
{
	return m_clientConnection->GetLocalTCPPort();
}
std::optional<pragma::networking::Port> pragma::networking::StandardClient::GetLocalUDPPort() const
{
	return m_clientConnection->GetLocalUDPPort();
}
