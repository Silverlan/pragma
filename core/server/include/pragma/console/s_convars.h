...
REGISTER_SHARED_CONVAR(sv_noclip_speed,"640",ConVarFlags::Replicated | ConVarFlags::Archive,"The speed at which players can move in noclip mode.");
...
REGISTER_SHARED_CONVAR(sv_tickrate,STRING(ENGINE_DEFAULT_TICK_RATE),ConVarFlags::Archive | ConVarFlags::Replicated,"Specifies the tickrate. A higher tickrate means smoother and more reliable physics, but also more data to transmit to clients. Higher values can result in more lag for clients.");
