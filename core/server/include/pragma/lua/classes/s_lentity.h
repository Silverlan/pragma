...
namespace Lua
{
	namespace Entity
	{
		namespace Server
		{
			...
			DLLSERVER void SendNetEvent(lua_State *l,EntityHandle &hEnt,uint32_t protocol,unsigned int eventId,::NetPacket packet,nwm::RecipientFilter &rp);
			DLLSERVER void SendNetEvent(lua_State *l,EntityHandle &hEnt,uint32_t protocol,unsigned int eventId,::NetPacket packet);
			DLLSERVER void SendNetEvent(lua_State *l,EntityHandle &hEnt,uint32_t protocol,unsigned int eventId,nwm::RecipientFilter &rp);
