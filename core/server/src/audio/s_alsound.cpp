...
SALSoundBase::SALSoundBase(bool bShared)
	: m_bShared(bShared)
{}
...
SALSound::~SALSound()
{
	SendEvent(NetEvent::SetIndex,[](NetPacket &p) {
		p->Write<uint32_t>(static_cast<uint32_t>(0));
	});
...
void SALSound::FadeIn(float time)
{
	...
	SendEvent(NetEvent::FadeIn,[&time](NetPacket &p) {
		p->Write<float>(time);
	});
}
...
void SALSound::FadeOut(float time)
{
	...
	SendEvent(NetEvent::FadeOut,[&time](NetPacket &p) {
		p->Write<float>(time);
	});
}
...
void SALSound::SetOffset(float offset)
{
	...
	m_offset = offset;
	SendEvent(NetEvent::SetOffset,[&offset](NetPacket &p) {
...
void SALSound::SetPitch(float pitch)
{
	...
	SendEvent(NetEvent::SetPitch,[&pitch](NetPacket &p) {
		p->Write<float>(pitch);
	});
}
...
void SALSound::SetLooping(bool loop)
{
	...
	SendEvent(NetEvent::SetLooping,[&loop](NetPacket &p) {
		p->Write<bool>(loop);
	});
}
...
void SALSound::SetGain(float gain)
{
	...
	SendEvent(NetEvent::SetGain,[&gain](NetPacket &p) {
		p->Write<float>(gain);
	});
}
...
void SALSound::SetPosition(const Vector3 &pos,bool bDontTransmit)
{
	...
	if(bDontTransmit == true)
		return;
	SendEvent(NetEvent::SetPos,[&pos](NetPacket &p) {
...
void SALSound::SetVelocity(const Vector3 &vel,bool bDontTransmit)
{
	...
	if(bDontTransmit == true)
		return;
	SendEvent(NetEvent::SetVelocity,[&vel](NetPacket &p) {
		nwm::write_vector(p,vel);
	});
}
...
void SALSound::SetDirection(const Vector3 &dir,bool bDontTransmit)
{
	...
	if(bDontTransmit == true)
		return;
	SendEvent(NetEvent::SetDirection,[&dir](NetPacket &p) {
		nwm::write_vector(p,dir);
	});
}
...
void SALSound::SetRelative(bool b)
{
	...
	SendEvent(NetEvent::SetRelative,[&b](NetPacket &p) {
		p->Write<bool>(b);
	});
}
...
void SALSound::SetReferenceDistance(float dist)
{
	...
	SendEvent(NetEvent::SetReferenceDistance,[&dist](NetPacket &p) {
		p->Write<float>(dist);
	});
}
...
void SALSound::SetRolloffFactor(float rolloff)
{
	...
	SendEvent(NetEvent::SetRolloffFactor,[&rolloff](NetPacket &p) {
		p->Write<float>(rolloff);
	});
}
...
void SALSound::SetRoomRolloffFactor(float roomFactor)
{
	...
	SendEvent(NetEvent::SetRoomRolloffFactor,[&roomFactor](NetPacket &p) {
		p->Write<float>(roomFactor);
	});
}
...
void SALSound::SetMaxDistance(float dist)
{
	...
	SendEvent(NetEvent::SetMaxDistance,[&dist](NetPacket &p) {
		p->Write<float>(dist);
	});
}
...
void SALSound::SetMinGain(float gain)
{
	...
	SendEvent(NetEvent::SetMinGain,[&gain](NetPacket &p) {
		p->Write<float>(gain);
	});
}
...
void SALSound::SetMaxGain(float gain)
{
	...
	SendEvent(NetEvent::SetMaxGain,[&gain](NetPacket &p) {
		p->Write<float>(gain);
	});
}
...
void SALSound::SetInnerConeAngle(float ang)
{
	...
	SendEvent(NetEvent::SetConeInnerAngle,[&ang](NetPacket &p) {
		p->Write<float>(ang);
	});
}
...
void SALSound::SetOuterConeAngle(float ang)
{
	...
	SendEvent(NetEvent::SetConeOuterAngle,[&ang](NetPacket &p) {
		p->Write<float>(ang);
	});
}
...
void SALSound::SetOuterConeGain(float gain)
{
	...
	SendEvent(NetEvent::SetConeOuterGain,[&gain](NetPacket &p) {
		p->Write<float>(gain);
	});
}
...
void SALSound::SetOuterConeGainHF(float gain)
{
	...
	SendEvent(NetEvent::SetConeOuterGainHF,[&gain](NetPacket &p) {
		p->Write<float>(gain);
	});
}
void SALSound::SetType(ALSoundType type)
{
	...
	SendEvent(NetEvent::SetType,[&type](NetPacket &p) {
		p->Write<ALSoundType>(type);
	});
}
...
void SALSound::SetFlags(unsigned int flags)
{
	...
	SendEvent(NetEvent::SetFlags,[&flags](NetPacket &p) {
		p->Write<unsigned int>(flags);
	});
}
...
void SALSound::SetSource(BaseEntity *ent)
{
	...
	SendEvent(NetEvent::SetSource,[&ent](NetPacket &p) {
...
void SALSound::SetFadeInDuration(float t)
{
	...
	SendEvent(NetEvent::SetFadeInDuration,[&t](NetPacket &p) {
		p->Write<float>(t);
	});
}
void SALSound::SetFadeOutDuration(float t)
{
	...
	SendEvent(NetEvent::SetFadeOutDuration,[&t](NetPacket &p) {
		p->Write<float>(t);
	});
}
...
void SALSound::SetPriority(uint32_t priority)
{
	...
	SendEvent(NetEvent::SetPriority,[priority](NetPacket &p) {
		p->Write<uint32_t>(priority);
	});
}
...
void SALSound::SetDopplerFactor(float factor)
{
	...
	SendEvent(NetEvent::SetDopplerFactor,[factor](NetPacket &p) {
		p->Write<float>(factor);
	});
}
...
void SALSound::SetLeftStereoAngle(float ang)
{
	...
	SendEvent(NetEvent::SetLeftStereoAngle,[ang](NetPacket &p) {
		p->Write<float>(ang);
	});
}
...
void SALSound::SetRightStereoAngle(float ang)
{
	...
	SendEvent(NetEvent::SetRightStereoAngle,[ang](NetPacket &p) {
		p->Write<float>(ang);
	});
}
...
void SALSound::SetAirAbsorptionFactor(float factor)
{
	...
	SendEvent(NetEvent::SetAirAbsorptionFactor,[factor](NetPacket &p) {
		p->Write<float>(factor);
	});
}
...
{
	SendEvent(NetEvent::RemoveEffect,[&effectName](NetPacket &p) {
		p->WriteString(effectName);
	});
}
...
{
	SendEvent(NetEvent::SetEntityMapIndex,[&idx](NetPacket &p) {
		p->Write<uint32_t>(idx);
	});
}
