...
ai::Schedule::Schedule() : std::enable_shared_from_this<Schedule>(), m_rootTask(pragma::util::make_shared<ai::BehaviorNode>(ai::BehaviorNode::Type::Sequence)) { m_rootTask->SetDebugName("Root"); }
