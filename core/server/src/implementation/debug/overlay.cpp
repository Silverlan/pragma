...
void pragma::debug::SDebugRenderer::DrawPoint(const Vector3 &pos, const Color &color, float duration)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWPOINT, p, pragma::networking::Protocol::FastUnreliable);
}
void pragma::debug::SDebugRenderer::DrawLine(const Vector3 &start, const Vector3 &end, const Color &color, float duration)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWLINE, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawBox(const Vector3 &center, const Vector3 &min, const Vector3 &max, const EulerAngles &ang, const Color &color, const Color &colorOutline, float duration)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWBOX, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawText(const std::string &text, const Vector3 &pos, const Vector2 &worldSize, const Color &color, float duration)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWTEXT, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawSphere(const Vector3 &origin, float radius, const Color &color, const Color &outlineColor, float duration, uint32_t recursionLevel)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWSPHERE, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawTruncatedCone(const Vector3 &origin, float startRadius, const Vector3 &dir, float dist, float endRadius, const Color &color, const Color &outlineColor, float duration, uint32_t segmentCount)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWTRUNCATEDCONE, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawCylinder(const Vector3 &origin, const Vector3 &dir, float dist, float radius, const Color &color, float duration, uint32_t segmentCount)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWCYLINDER, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawCone(const Vector3 &origin, const Vector3 &dir, float dist, float angle, const Color &color, const Color &outlineColor, float duration, uint32_t segmentCount)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWCONE, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawAxis(const Vector3 &origin, const EulerAngles &ang, float duration)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWAXIS, p, pragma::networking::Protocol::FastUnreliable);
}
...
void pragma::debug::SDebugRenderer::DrawPath(const std::vector<Vector3> &path, const Color &color, float duration)
{
	...
	for(auto &v : path)
		p->Write<Vector3>(v);
	p << color << duration;
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWPATH, p, pragma::networking::Protocol::FastUnreliable);
}
void pragma::debug::SDebugRenderer::DrawSpline(const std::vector<Vector3> &path, const Color &color, uint32_t segmentCount, float curvature, float duration)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWSPLINE, p, pragma::networking::Protocol::FastUnreliable);
}
void pragma::debug::SDebugRenderer::DrawPlane(const Vector3 &n, float dist, const Color &color, float duration)
{
	...
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAWPLANE, p, pragma::networking::Protocol::FastUnreliable);
}
void pragma::debug::SDebugRenderer::DrawPlane(const pragma::math::Plane &plane, const Color &color, float duration) { DrawPlane(const_cast<pragma::math::Plane &>(plane).GetNormal(), static_cast<float>(plane.GetDistance()), color, duration); }
void pragma::debug::SDebugRenderer::DrawMesh(const std::vector<Vector3> &meshVerts, const Color &color, const Color &colorOutline, float duration)
{
	...
	p->Write(reinterpret_cast<const uint8_t *>(meshVerts.data()), pragma::util::size_of_container(meshVerts));
	p->Write<Color>(color);
	p->Write<Color>(colorOutline);
	p->Write<float>(duration);
	pragma::ServerState::Get()->SendPacket(pragma::networking::net_messages::client::DEBUG_DRAW_MESH, p, pragma::networking::Protocol::FastUnreliable);
}
