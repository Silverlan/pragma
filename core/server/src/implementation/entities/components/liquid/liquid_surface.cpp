...
void SLiquidSurfaceComponent::InitializeLuaObject(lua::State *l) { return BaseLiquidSurfaceComponent::InitializeLuaObject<std::remove_reference_t<decltype(*this)>>(l); }
