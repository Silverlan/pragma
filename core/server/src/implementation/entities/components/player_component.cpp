...
SPlayerComponent::SPlayerComponent(pragma::ecs::BaseEntity &ent) : BasePlayerComponent(ent), SBaseNetComponent(), m_session(nullptr), m_bAuthed(false), m_bGameReady(false) { s_players.push_back(this); }
