...
SGame::SGame(pragma::NetworkState *state) : pragma::Game(state)
{
	g_game = this;
...
static void CVAR_CALLBACK_host_timescale(pragma::NetworkState *, const ConVar &, float, float val) { SGame::Get()->SetTimeScale(val); }
namespace {
