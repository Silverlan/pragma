...
namespace Lua {
	namespace AISchedule {
		...
		static void SetParameterEntity(lua_State *l, pragma::ai::Schedule &schedule, uint8_t idx, pragma::ecs::BaseEntity &hEnt);
...
void Lua::AISchedule::register_class(lua_State *l, luabind::module_ &mod)
{
	...
	classDef.def("SetParameterEntity", static_cast<void (*)(lua_State *, pragma::ai::Schedule &, uint8_t, pragma::ecs::BaseEntity &)>(&SetParameterEntity));
...
void Lua::AISchedule::AddTask(lua_State *, pragma::ai::Schedule &schedule, ::pragma::ai::BehaviorNode &node) { schedule.GetRootNode().AddNode(node.shared_from_this()); }
...
void Lua::AISchedule::SetParameterEntity(lua_State *l, pragma::ai::Schedule &schedule, uint8_t idx, pragma::ecs::BaseEntity &ent) { schedule.SetParameter(idx, &ent); }
...
void Lua::AISchedule::SetInterruptFlags(lua_State *l, pragma::ai::Schedule &schedule, uint8_t flags) { schedule.SetInterruptFlags(flags); }
void Lua::AISchedule::AddInterruptFlags(lua_State *l, pragma::ai::Schedule &schedule, uint8_t flags) { schedule.AddInterruptFlags(flags); }
void Lua::AISchedule::GetInterruptFlags(lua_State *l, pragma::ai::Schedule &schedule) { Lua::PushInt(l, schedule.GetInterruptFlags()); }
