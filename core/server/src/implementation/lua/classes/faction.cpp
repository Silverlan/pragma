...
void Lua::Faction::SetDisposition(lua_State *, ::Faction &faction, ::Faction &factionTgt, uint32_t disposition, bool revert, int32_t priority) { faction.SetDisposition(factionTgt, static_cast<DISPOSITION>(disposition), revert, priority); }
...
void Lua::Faction::SetEnemyFaction(lua_State *, ::Faction &faction, ::Faction &factionTgt, bool revert, int32_t priority) { faction.SetEnemyFaction(factionTgt, revert, priority); }
...
void Lua::Faction::SetAlliedFaction(lua_State *, ::Faction &faction, ::Faction &factionTgt, bool revert, int32_t priority) { faction.SetAlliedFaction(factionTgt, revert, priority); }
...
void Lua::Faction::SetNeutralFaction(lua_State *, ::Faction &faction, ::Faction &factionTgt, bool revert, int32_t priority) { faction.SetNeutralFaction(factionTgt, revert, priority); }
...
void Lua::Faction::SetFearsomeFaction(lua_State *, ::Faction &faction, ::Faction &factionTgt, bool revert, int32_t priority) { faction.SetFearsomeFaction(factionTgt, revert, priority); }
