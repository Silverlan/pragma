...
void Lua::DebugRenderer::Server::DrawPoint(const pragma::debug::DebugRenderInfo &renderInfo) { SDebugRenderer::DrawPoint(renderInfo.pose.GetOrigin(), renderInfo.color, renderInfo.duration); }
void Lua::DebugRenderer::Server::DrawLine(const Vector3 &start, const Vector3 &end, const pragma::debug::DebugRenderInfo &renderInfo) { SDebugRenderer::DrawLine(renderInfo.pose.GetOrigin() + start, renderInfo.pose.GetOrigin() + end, renderInfo.color, renderInfo.duration); }
...
void Lua::DebugRenderer::Server::DrawAxis(const pragma::debug::DebugRenderInfo &renderInfo) { SDebugRenderer::DrawAxis(renderInfo.pose.GetOrigin(), EulerAngles {renderInfo.pose.GetRotation()}, renderInfo.duration); }
void Lua::DebugRenderer::Server::DrawText(const std::string &text, const ::Vector2 &size, const pragma::debug::DebugRenderInfo &renderInfo) { ::SDebugRenderer::DrawText(text, renderInfo.pose.GetOrigin(), size, renderInfo.color, renderInfo.duration); }
void Lua::DebugRenderer::Server::DrawText(const std::string &text, float size, const pragma::debug::DebugRenderInfo &renderInfo) { ::SDebugRenderer::DrawText(text, renderInfo.pose.GetOrigin(), size, renderInfo.color, renderInfo.duration); }
...
void Lua::DebugRenderer::Server::DrawPlane(const pragma::debug::DebugRenderInfo &renderInfo) { ::SDebugRenderer::DrawPlane(umath::Plane {uquat::forward(renderInfo.pose.GetRotation()), renderInfo.pose.GetOrigin()}, renderInfo.color, renderInfo.duration); }
