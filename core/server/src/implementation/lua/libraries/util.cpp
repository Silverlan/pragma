...
luabind::object Lua::util::Server::fire_bullets(lua::State *l, const BulletInfo &bulletInfo, bool hitReport)
{
	...
	auto r = Lua::util::fire_bullets(l, const_cast<BulletInfo &>(bulletInfo), hitReport, [&hitPositions, &hitNormals, &hitSurfaceMaterials, &start, &numTracer](DamageInfo &dmg, pragma::physics::TraceData &, pragma::physics::TraceResult &result, uint32_t &tracerCount) {
