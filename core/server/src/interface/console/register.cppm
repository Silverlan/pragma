...
export namespace pragma::console {
	...
	namespace server {
		...
		DummyReturnValue register_command(const std::string &scmd, void(*fc)(NetworkState *, pragma::BasePlayerComponent *, std::vector<std::string> &), ConVarFlags flags, const std::string &help = "");
		...
		DummyReturnValue register_toggle_command(const std::string &scmd, void(*fcIn)(NetworkState *, pragma::BasePlayerComponent *, std::vector<std::string> &), void(*fcOut)(NetworkState *, pragma::BasePlayerComponent *, std::vector<std::string> &), ConVarFlags flags, const std::string &help = "");
