...
export namespace pragma::ecs {
	class DLLSERVER SShooterComponent final : public BaseShooterComponent, public SBaseNetComponent {
	  public:
		...
		void FireBullets(const BulletInfo &bulletInfo, const std::function<bool(DamageInfo &, pragma::ecs::BaseEntity *)> &fCallback, std::vector<TraceResult> &outHitTargets, bool bMaster = true);
