...
namespace pragma
{
	class DLLNETWORK BaseDebugTextComponent
	...
	class DLLNETWORK BaseDebugPointComponent
		: public BaseEntityComponent
	{
	public:
		virtual void Initialize() override;
	...
	class DLLNETWORK BaseDebugLineComponent
		: public BaseEntityComponent
	{
	public:
		virtual void Initialize() override;
	...
	class DLLNETWORK BaseDebugBoxComponent
		: public BaseEntityComponent,public BaseDebugOutlineComponent
	{
	public:
		virtual void Initialize() override;
	...
	class DLLNETWORK BaseDebugSphereComponent
		: public BaseEntityComponent,
		public BaseDebugOutlineComponent
	{
	public:
		virtual void Initialize() override;
	protected:
	...
	class DLLNETWORK BaseDebugConeComponent
		: public BaseEntityComponent,
		public BaseDebugOutlineComponent
	{
	public:
	...
	class DLLNETWORK BaseDebugCylinderComponent
		: public BaseEntityComponent,
		public BaseDebugOutlineComponent
	{
	public:
	...
	class DLLNETWORK BaseDebugPlaneComponent
		: public BaseEntityComponent
	{
	public:
		virtual void Initialize() override;
