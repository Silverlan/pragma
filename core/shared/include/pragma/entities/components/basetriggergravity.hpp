...
namespace pragma
{
	namespace Entity
	{
		namespace TriggerGravity
		{
			...
			{
				AffectDirection = 2048,
				ResetOnEndTouch = AffectDirection<<1,
				ChangeOrientation = ResetOnEndTouch<<1
			};

			enum class NetFlags : uint8_t
			{
				None = 0,
				StartTouch = 1,
				UseForce = StartTouch<<1
			};
	...
	class DLLNETWORK BaseEntityTriggerGravityComponent
