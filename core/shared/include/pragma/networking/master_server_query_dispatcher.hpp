...
namespace pragma::networking
{
	...
	public:
		...
		{
			Filter(const std::string &networkLayerIdentifier)
				: networkLayerIdentifier{networkLayerIdentifier}
			{}
...
{
	return std::unique_ptr<IMasterServerQueryDispatcher,void(*)(IMasterServerQueryDispatcher*)>{
		new TMasterServerQueryDispatcher{},
			[](IMasterServerQueryDispatcher *p) {
			p->Release();
			delete p;
		}
	};
