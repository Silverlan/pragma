#ifndef __PHYS_WATER_SURFACE_SIMULATOR_HPP__
#define __PHYS_WATER_SURFACE_SIMULATOR_HPP__
...
class DLLNETWORK PhysWaterSurfaceSimulator
	: public std::enable_shared_from_this<PhysWaterSurfaceSimulator>
{
public:
#pragma pack(push,1)
