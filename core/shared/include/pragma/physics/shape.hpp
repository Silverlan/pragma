#ifndef __PHYS_SHAPE_HPP__
#define __PHYS_SHAPE_HPP__
...
namespace pragma::physics
{
	...
	class DLLNETWORK ICapsuleShape
	...
	class DLLNETWORK IConvexHullShape
		: virtual public IConvexShape
	{
	public:
		virtual void InitializeLuaObject(lua_State *lua) override;
	...
	class DLLNETWORK ITriangleShape
		: virtual public IShape
	{
	public:
		virtual void InitializeLuaObject(lua_State *lua) override;
