...
EntityIteratorData::EntityIteratorData(Game &game)
	: game(game),entities(std::make_unique<EntityContainer>(game.GetBaseEntities(),game.GetBaseEntityCount()))
{}
EntityIteratorData::EntityIteratorData(Game &game,const std::vector<pragma::BaseEntityComponent*> &components,std::size_t count)
...
BaseEntityIterator::BaseEntityIterator(const std::shared_ptr<EntityIteratorData> &itData,bool bEndIterator)
	: m_iteratorData(itData)
{
...
EntityIterator::EntityIterator(Game &game,bool)
	: m_iteratorData(std::make_shared<EntityIteratorData>(game))
{}
EntityIterator::EntityIterator(Game &game,FilterFlags filterFlags)
...
BaseEntityIterator EntityIterator::begin() const
{
	return BaseEntityIterator{m_iteratorData,false};
}
BaseEntityIterator EntityIterator::end() const
{
	return BaseEntityIterator{m_iteratorData,true};
}
