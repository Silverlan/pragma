...
void register_shared_convars(ConVarMap &map) {
	...
	map.RegisterConVar<udm::Float>("sv_player_air_move_scale", 0.05, ConVarFlags::Replicated | ConVarFlags::Archive, "The scale at which players are still able to move while in the air. 0 = Players can't move until they've landed, 1 = Players can move freely while in the air");
