...
void BaseEntity::SetCollisionFilterMask(pragma::physics::CollisionMask filterMask)
{
	auto physC = GetPhysicsComponent();
	if(!physC)
		return;
...
void BaseEntity::SetCollisionFilterGroup(pragma::physics::CollisionMask filterGroup)
{
	auto physC = GetPhysicsComponent();
	if(!physC)
		return;
...
pragma::physics::CollisionMask BaseEntity::GetCollisionFilterGroup() const
{
	auto physC = GetPhysicsComponent();
	if(!physC)
...
pragma::physics::CollisionMask BaseEntity::GetCollisionFilterMask() const
{
	auto physC = GetPhysicsComponent();
	if(!physC)
		return pragma::physics::CollisionMask::None;
