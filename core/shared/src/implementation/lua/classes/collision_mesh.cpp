...
luabind::tableT<Vector3> Lua::CollisionMesh::GetVertices(lua::State *l, ::pragma::physics::CollisionMesh &mesh) { return Lua::vector_to_table(l, mesh.GetVertices()); }
...
luabind::tableT<int32_t> Lua::CollisionMesh::GetSurfaceMaterialIds(lua::State *l, ::pragma::physics::CollisionMesh &mesh) { return Lua::vector_to_table(l, mesh.GetSurfaceMaterials()); }
