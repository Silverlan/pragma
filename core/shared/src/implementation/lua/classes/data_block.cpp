...
void Lua::DataBlock::GetInt(lua::State *l, pragma::datasystem::Block &data, const std::string &val, int32_t def) { Lua::PushInt(l, data.GetInt(val, def)); }
void Lua::DataBlock::GetFloat(lua::State *l, pragma::datasystem::Block &data, const std::string &val, float def) { Lua::PushNumber(l, data.GetFloat(val, def)); }
void Lua::DataBlock::GetBool(lua::State *l, pragma::datasystem::Block &data, const std::string &val, bool def) { Lua::PushBool(l, data.GetBool(val, def)); }
void Lua::DataBlock::GetString(lua::State *l, pragma::datasystem::Block &data, const std::string &val, const std::string &def) { Lua::PushString(l, data.GetString(val, def)); }
...
void Lua::DataBlock::GetInt(lua::State *l, pragma::datasystem::Block &data, const std::string &val) { Lua::PushInt(l, data.GetInt(val)); }
void Lua::DataBlock::GetFloat(lua::State *l, pragma::datasystem::Block &data, const std::string &val) { Lua::PushNumber(l, data.GetFloat(val)); }
void Lua::DataBlock::GetBool(lua::State *l, pragma::datasystem::Block &data, const std::string &val) { Lua::PushBool(l, data.GetBool(val)); }
void Lua::DataBlock::GetString(lua::State *l, pragma::datasystem::Block &data, const std::string &val) { Lua::PushString(l, data.GetString(val)); }
...
void Lua::DataBlock::GetChildBlocks(lua::State *l, pragma::datasystem::Block &data)
{
	...
	for(auto &pair : *data.GetData()) {
		...
		Lua::Push(l, std::static_pointer_cast<pragma::datasystem::Block>(pair.second));
...
void Lua::DataBlock::IsEmpty(lua::State *l, pragma::datasystem::Block &data) { Lua::PushBool(l, data.IsEmpty()); }
void Lua::DataBlock::HasValue(lua::State *l, pragma::datasystem::Block &data, const std::string &key) { Lua::PushBool(l, data.HasValue(key)); }
...
void Lua::DataBlock::IsString(lua::State *l, pragma::datasystem::Block &data, const std::string &key) { Lua::PushBool(l, data.IsString(key)); }
void Lua::DataBlock::IsInt(lua::State *l, pragma::datasystem::Block &data, const std::string &key) { Lua::PushBool(l, data.IsInt(key)); }
void Lua::DataBlock::IsFloat(lua::State *l, pragma::datasystem::Block &data, const std::string &key) { Lua::PushBool(l, data.IsFloat(key)); }
void Lua::DataBlock::IsBool(lua::State *l, pragma::datasystem::Block &data, const std::string &key) { Lua::PushBool(l, data.IsBool(key)); }
void Lua::DataBlock::IsColor(lua::State *l, pragma::datasystem::Block &data, const std::string &key)
{
	...
	Lua::PushBool(l, typeid(*val) == typeid(pragma::datasystem::Color));
}
void Lua::DataBlock::IsVector(lua::State *l, pragma::datasystem::Block &data, const std::string &key)
{
	...
	Lua::PushBool(l, typeid(*val) == typeid(pragma::datasystem::Vector));
}
void Lua::DataBlock::IsVector4(lua::State *l, pragma::datasystem::Block &data, const std::string &key)
{
	...
	Lua::PushBool(l, typeid(*val) == typeid(pragma::datasystem::Vector4));
}
void Lua::DataBlock::ToString(lua::State *l, pragma::datasystem::Block &data, const std::string &rootIdentifier, uint8_t tabDepth) { Lua::PushString(l, data.ToString(rootIdentifier, tabDepth)); }
void Lua::DataBlock::ToString(lua::State *l, pragma::datasystem::Block &data, const std::string &rootIdentifier) { Lua::PushString(l, data.ToString(rootIdentifier)); }
void Lua::DataBlock::ToString(lua::State *l, pragma::datasystem::Block &data, uint8_t tabDepth) { Lua::PushString(l, data.ToString({}, tabDepth)); }
void Lua::DataBlock::ToString(lua::State *l, pragma::datasystem::Block &data) { Lua::PushString(l, data.ToString({})); }
