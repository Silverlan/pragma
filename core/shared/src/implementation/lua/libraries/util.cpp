...
{
	auto raw = fileName + DOT_FILE_EXTENSION;
	if(pragma::fs::exists(SCRIPT_DIRECTORY_SLASH + raw))
		return raw;
	auto precompiled = fileName + DOT_FILE_EXTENSION_PRECOMPILED;
	if(pragma::fs::exists(SCRIPT_DIRECTORY_SLASH + precompiled))
		return precompiled;
	return {};
}
...
void Lua::util::register_world_data(lua::State *l, luabind::module_ &mod)
{
	...
	defWorldData.def(
	  "Save", +[](lua::State *l, pragma::asset::WorldData &worldData, ::udm::AssetDataArg assetData, const std::string &mapName) -> mult<bool, opt<std::string>> {
		  std::string err;
	...
	defWorldData.def(
	  "Save", +[](lua::State *l, pragma::asset::WorldData &worldData, const std::string &fileName, const std::string &mapName) -> mult<bool, opt<std::string>> {
		  std::string err;
...
void Lua::util::register_shared_generic(lua::State *l, luabind::module_ &mod)
{
	mod[(luabind::def("is_valid", static_cast<bool (*)(lua::State *)>(is_valid)), luabind::def("is_valid", static_cast<bool (*)(lua::State *, const luabind::object &)>(is_valid)), luabind::def("remove", static_cast<void (*)(lua::State *, const luabind::object &)>(remove)),
	  luabind::def("remove", static_cast<void (*)(lua::State *, const luabind::object &, bool)>(remove)),
	  luabind::def(
	    "remove", +[]() {}),
	  luabind::def(
	  ...
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const std::string &, const luabind::object &, const luabind::object &, const luabind::object &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const std::string &, const luabind::object &, const luabind::object &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const std::string &, const luabind::object &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const std::string &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const std::string &, const luabind::object &)>(register_class)), luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const std::string &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const luabind::table<> &, const std::string &, const luabind::object &, const luabind::object &, const luabind::object &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const luabind::table<> &, const std::string &, const luabind::object &, const luabind::object &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const luabind::table<> &, const std::string &, const luabind::object &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const luabind::table<> &, const std::string &, const luabind::object &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const luabind::table<> &, const std::string &, const luabind::object &)>(register_class)),
	  luabind::def("register_class", static_cast<luabind::object (*)(lua::State *, const luabind::table<> &, const std::string &)>(register_class)), luabind::def("local_to_world", static_cast<Quat (*)(lua::State *, const Quat &, const Quat &)>(local_to_world)),
	  ...
	  luabind::def("world_to_local", static_cast<void (*)(lua::State *, const Vector3 &, const Quat &, const Vector3 &, const Quat &)>(world_to_local)), luabind::def("get_pretty_duration", static_cast<std::string (*)(lua::State *, uint32_t, uint32_t, bool)>(get_pretty_duration)),
	  luabind::def("get_pretty_duration", static_cast<std::string (*)(lua::State *, uint32_t, uint32_t)>(get_pretty_duration)), luabind::def("get_pretty_duration", static_cast<std::string (*)(lua::State *, uint32_t)>(get_pretty_duration)), luabind::def("get_pretty_time", get_pretty_time),
	  luabind::def(
	    "get_object_hash", +[](userData o) { return std::hash<void *> {}(lua::to_user_data(o.interpreter(), 1)); }),
	  luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LColorProperty &, const ::Color &, float)>(fade_property)), luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LVector2iProperty &, const ::Vector2i &, float)>(fade_property)),
	  luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LVector3Property &, const Vector3 &, float)>(fade_property)), luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LVector3iProperty &, const Vector3i &, float)>(fade_property)),
	  luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LVector4Property &, const ::Vector4 &, float)>(fade_property)), luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LVector4iProperty &, const ::Vector4i &, float)>(fade_property)),
	  luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LQuatProperty &, const Quat &, float)>(fade_property)), luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LEulerAnglesProperty &, const EulerAngles &, float)>(fade_property)),
	  luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LGenericIntPropertyWrapper &, const int64_t &, float)>(fade_property)),
	  luabind::def("fade_property", static_cast<luabind::object (*)(lua::State *, LGenericFloatPropertyWrapper &, const double &, float)>(fade_property)), luabind::def("round_string", static_cast<std::string (*)(lua::State *, float, uint32_t)>(round_string)),
	  luabind::def("round_string", static_cast<std::string (*)(lua::State *, float)>(round_string)), luabind::def("get_type_name", get_type_name), luabind::def("is_same_object", is_same_object), luabind::def("clamp_resolution_to_aspect_ratio", clamp_resolution_to_aspect_ratio),
	  luabind::def("get_class_value", get_class_value), luabind::def("pack_zip_archive", pack_zip_archive), luabind::def("world_space_point_to_screen_space_uv", static_cast<void (*)(lua::State *, const Vector3 &, const ::Mat4 &, float, float)>(world_space_point_to_screen_space_uv)),
	  luabind::def("world_space_direction_to_screen_space", world_space_direction_to_screen_space), luabind::def("calc_screen_space_distance_to_world_space_position", calc_screenspace_distance_to_worldspace_position), luabind::def("depth_to_distance", depth_to_distance),
	  ...
	  luabind::def(
	    "generate_hair_data", +[](float hairPerArea, const pragma::geometry::ModelSubMesh &mesh) {
		    ...
		    meshInterface->getVertexPosition = [&mesh](uint32_t vertIdx) -> Vector3 { return mesh.GetVertexPosition(vertIdx) * static_cast<float>(units_to_metres(1.f)); };
	...
	mod[(luabind::def("is_valid", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3) -> bool { return is_valid(l, o0) && is_valid(l, o1) && is_valid(l, o2) && is_valid(l, o3); }))];
	mod[(luabind::def(
	  "is_valid", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4) -> bool { return is_valid(l, o0) && is_valid(l, o1) && is_valid(l, o2) && is_valid(l, o3) && is_valid(l, o4); }))];
	mod[(luabind::def(
	  "is_valid", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5) -> bool {
		  return is_valid(l, o0) && is_valid(l, o1) && is_valid(l, o2) && is_valid(l, o3) && is_valid(l, o4) && is_valid(l, o5);
	  }))];
	mod[(luabind::def(
	  "is_valid", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5, const luabind::object &o6) -> bool {
		  return is_valid(l, o0) && is_valid(l, o1) && is_valid(l, o2) && is_valid(l, o3) && is_valid(l, o4) && is_valid(l, o5) && is_valid(l, o6);
	  }))];
	mod[(luabind::def(
	  "is_valid", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5, const luabind::object &o6, const luabind::object &o7) -> bool {
		  return is_valid(l, o0) && is_valid(l, o1) && is_valid(l, o2) && is_valid(l, o3) && is_valid(l, o4) && is_valid(l, o5) && is_valid(l, o6) && is_valid(l, o7);
	  }))];
	mod[(luabind::def(
	  "is_valid", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5, const luabind::object &o6, const luabind::object &o7, const luabind::object &o8) -> bool {
		  return is_valid(l, o0) && is_valid(l, o1) && is_valid(l, o2) && is_valid(l, o3) && is_valid(l, o4) && is_valid(l, o5) && is_valid(l, o6) && is_valid(l, o7) && is_valid(l, o8);
	  }))];

	// remove overloads for up to 8 arguments
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1) {
		  remove(l, o0);
		  remove(l, o1);
	  }))];
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2) {
		  remove(l, o0);
		  remove(l, o1);
		  remove(l, o2);
	  }))];
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3) {
		  remove(l, o0);
		  remove(l, o1);
		  remove(l, o2);
		  remove(l, o3);
	...
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4) {
		  remove(l, o0);
		  remove(l, o1);
		  remove(l, o2);
		  remove(l, o3);
	...
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5) {
		  remove(l, o0);
		  remove(l, o1);
		  remove(l, o2);
		  remove(l, o3);
	...
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5, const luabind::object &o6) {
		  remove(l, o0);
		  remove(l, o1);
		  remove(l, o2);
		  remove(l, o3);
	...
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5, const luabind::object &o6, const luabind::object &o7) {
		  remove(l, o0);
		  remove(l, o1);
		  remove(l, o2);
		  remove(l, o3);
	...
	mod[(luabind::def(
	  "remove", +[](lua::State *l, const luabind::object o0, const luabind::object &o1, const luabind::object &o2, const luabind::object &o3, const luabind::object &o4, const luabind::object &o5, const luabind::object &o6, const luabind::object &o7, const luabind::object &o8) {
		  remove(l, o0);
		  remove(l, o1);
		  remove(l, o2);
		  remove(l, o3);
...
void Lua::util::register_shared(lua::State *l, luabind::module_ &mod)
{
	register_shared_generic(l, mod);
	mod[(luabind::def("is_valid_entity", static_cast<bool (*)(lua::State *)>(is_valid_entity)), luabind::def("is_valid_entity", static_cast<bool (*)(lua::State *, const luabind::object &)>(is_valid_entity)),
	  luabind::def("shake_screen", static_cast<void (*)(lua::State *, const Vector3 &, float, float, float, float, float, float)>(shake_screen)), luabind::def("shake_screen", static_cast<void (*)(lua::State *, float, float, float, float, float)>(shake_screen)),
	  luabind::def("read_scene_file", read_scene_file), luabind::def("is_cli_only", &pragma::Engine::IsCLIOnly), luabind::def("is_sandboxed", &pragma::Engine::IsSandboxed), luabind::def("is_managed_by_package_manager", &pragma::Engine::IsManagedByPackageManager),
...
static Lua::mult<bool, Lua::opt<std::string>> exec_python(lua::State *l, const std::string &fileName) { return exec_python(l, fileName, {}); }
void Lua::util::register_library(lua::State *l)
{
	auto pythonMod = luabind::module(l, "python");
	pythonMod[(luabind::def(
	             "run",
	             +[](lua::State *l, const std::string &code) -> mult<bool, opt<std::string>> {
	  ...
	  luabind::def("exec", static_cast<mult<bool, opt<std::string>> (*)(lua::State *, const std::string &)>(&exec_python)), luabind::def("exec", static_cast<mult<bool, opt<std::string>> (*)(lua::State *, const std::string &, const std::vector<std::string> &)>(&exec_python)),
	  luabind::def("init_blender", &pragma::python::init_blender), luabind::def("reload", &pragma::python::reload))];
	...
	defRigConfig.def(
	  "Save", +[](lua::State *l, pragma::ik::RigConfig &rigConfig, const std::string &fileName) -> std::pair<bool, std::optional<std::string>> {
		  auto fname = fileName;
	...
	utilMod[(luabind::def("splash_damage", splash_damage), luabind::def("get_date_time", static_cast<std::string (*)(const std::string &)>(date_time)), luabind::def("get_date_time", static_cast<std::string (*)()>(date_time)),
	  luabind::def("is_table", static_cast<bool (*)(luabind::argument)>(is_table)), luabind::def("is_table", static_cast<bool (*)()>(is_table)), luabind::def("get_faded_time_factor", static_cast<float (*)(float, float, float, float)>(get_faded_time_factor)),
	  luabind::def("get_faded_time_factor", static_cast<float (*)(float, float, float)>(get_faded_time_factor)), luabind::def("get_scale_factor", static_cast<float (*)(float, float, float)>(get_scale_factor)),
	  luabind::def("get_scale_factor", static_cast<float (*)(float, float)>(get_scale_factor)), luabind::def("open_path_in_explorer", static_cast<void (*)(const std::string &, const std::string &)>(open_path_in_explorer)),
	  luabind::def("open_path_in_explorer", static_cast<void (*)(const std::string &)>(open_path_in_explorer)), luabind::def("get_pretty_bytes", get_pretty_bytes), luabind::def("units_to_metres", units_to_metres), luabind::def("metres_to_units", metres_to_units),
	  luabind::def("variable_type_to_string", variable_type_to_string), luabind::def("open_url_in_browser", open_url_in_browser), luabind::def("get_addon_path", static_cast<std::string (*)(lua::State *)>(get_addon_path)), luabind::def("get_string_hash", get_string_hash),
	  luabind::def(
	    "generate_uuid_v4", +[]() -> Uuid { return Uuid {pragma::util::generate_uuid_v4()}; }),
	  luabind::def(
	    "generate_uuid_v4", +[](size_t seed) -> Uuid { return Uuid {pragma::util::generate_uuid_v4(seed)}; }),
	  luabind::def(
	    "generate_uuid_v4",
	    +[](const std::string &str) -> Uuid {
		    auto seed = std::hash<std::string> {}(str);
		    return Uuid {pragma::util::generate_uuid_v4(seed)};
	    }),
	  luabind::def("run_updater", +[](pragma::Engine &engine) { engine.SetRunUpdaterOnClose(true); }))];
	auto defUuid = luabind::class_<Uuid>("Uuid");
	defUuid.def("__tostring", +[](const Uuid &uuid) { return pragma::util::uuid_to_string(uuid.value); });
	defUuid.def(
	  "IsValid", +[](const Uuid &uuid) {
	...
	utilMod[defUuid];
	pragma::LuaCore::define_custom_constructor<Uuid, +[](const std::string &uuid) -> Uuid { return Uuid {pragma::util::uuid_string_to_bytes(uuid)}; }, const std::string &>(l);
}
std::string Lua::global::get_script_path() { return GetIncludePath(); }
...
bool Lua::util::is_valid(lua::State *l) { return false; }
bool Lua::util::is_valid(lua::State *l, const luabind::object &o)
{
	if(!o)
		return false;
...
bool Lua::util::is_valid_entity(lua::State *l)
{
	if(!IsSet(l, 1) || !Lua::IsType<pragma::ecs::BaseEntity>(l, 1))
		return false;
	return is_valid(l);
}
static bool is_entity(const luabind::object &o) { return luabind::object_cast_nothrow<EntityHandle *>(o, static_cast<EntityHandle *>(nullptr)); }
bool Lua::util::is_valid_entity(lua::State *l, const luabind::object &o)
{
	if(!o || !is_entity(o))
		return false;
	return is_valid(l, o);
...
{
	auto type = static_cast<Type>(luabind::type(o));
	if(type != Type::Table && is_valid(l, o) == false)
		return;
...
bool Lua::util::is_table(luabind::argument arg) { return static_cast<Type>(luabind::type(arg)) == Type::Table; }
...
static luabind::object register_class(lua::State *l, const std::string &pclassName, uint32_t idxBaseClassStart, const luabind::table<> *baseTable = nullptr)
{
	...
	auto fRegisterBaseClasses = [l, nParentClasses, idxBaseClassStart]() {
		for(auto i = idxBaseClassStart; i <= (nParentClasses + 1); ++i) {
			...
			Lua::PushValue(l, i);  /* 3 */
			std::string err;
			if(pragma::scripting::lua_core::protected_call(l, 1, 0, &err) != Lua::StatusCode::Ok) /* 1 */
				pragma::scripting::lua_core::raise_error(l, err);                                 // TODO: Is this okay to do here? Maybe we should throw an exception instead.
		}
	};
	...
	std::string err;
	auto r = pragma::scripting::lua_core::run_string(l, ss.str(), "internal", 1); /* 1 */
	...
	if(r == Lua::StatusCode::Ok) {
		...
		oClass["__init"] = luabind::make_function(
		  l, +[](lua::State *l, const luabind::object &o) {
		...
		oClass["__tostring"] = luabind::make_function(l, +[](lua::State *l, const luabind::object &o) -> std::string { return luabind::get_class_info(luabind::from_stack(l, 1)).name; });
		fRegisterBaseClasses();
		Lua::Pop(l, 1); /* 0 */
...
luabind::object Lua::util::register_class(lua::State *l, const std::string &className, const luabind::object &oBase0) { return ::register_class(l, className, oBase0, 2); }
luabind::object Lua::util::register_class(lua::State *l, const std::string &className, const luabind::object &oBase0, const luabind::object &oBase1) { return ::register_class(l, className, 2); }
luabind::object Lua::util::register_class(lua::State *l, const std::string &className, const luabind::object &oBase0, const luabind::object &oBase1, const luabind::object &oBase2) { return ::register_class(l, className, 2); }
...
luabind::object Lua::util::register_class(lua::State *l, const luabind::table<> &t, const std::string &className, const luabind::object &oBase0, const luabind::object &oBase1) { return ::register_class(l, className, 3); }
luabind::object Lua::util::register_class(lua::State *l, const luabind::table<> &t, const std::string &className, const luabind::object &oBase0, const luabind::object &oBase1, const luabind::object &oBase2) { return ::register_class(l, className, 3); }
luabind::object Lua::util::register_class(lua::State *l, const luabind::table<> &t, const std::string &className, const luabind::object &oBase0, const luabind::object &oBase1, const luabind::object &oBase2, const luabind::object &oBase3) { return ::register_class(l, className, 3); }
luabind::object Lua::util::register_class(lua::State *l, const luabind::table<> &t, const std::string &className, const luabind::object &oBase0, const luabind::object &oBase1, const luabind::object &oBase2, const luabind::object &oBase3, const luabind::object &oBase4)
{
	return ::register_class(l, className, 3);
}
static void shake_screen(lua::State *l, const Vector3 &pos, float radius, float amplitude, float frequency, float duration, float fadeIn, float fadeOut, bool useRadius)
{
	auto *nw = pragma::Engine::Get()->GetNetworkState(l);
	auto *game = nw->GetGameState();
...
Vector3 Lua::util::local_to_world(lua::State *l, const Vector3 &vLocal, const Quat &rLocal, const Vector3 &v)
{
	auto vOut = v;
	uvec::local_to_world(vLocal, rLocal, vOut);
	return vOut;
}
void Lua::util::local_to_world(lua::State *l, const Vector3 &vLocal, const Quat &rLocal, const Vector3 &v, const Quat &r)
{
	auto vOut = v;
	auto rOut = r;
...
Quat Lua::util::world_to_local(lua::State *l, const Quat &rLocal, const Quat &r)
{
	auto rOut = r;
	uvec::world_to_local(rLocal, rOut);
	return rOut;
}
Vector3 Lua::util::world_to_local(lua::State *l, const Vector3 &vLocal, const Quat &rLocal, const Vector3 &v)
{
	auto vOut = v;
	uvec::world_to_local(vLocal, rLocal, vOut);
	return vOut;
}
void Lua::util::world_to_local(lua::State *l, const Vector3 &vLocal, const Quat &rLocal, const Vector3 &v, const Quat &r)
{
	auto vOut = v;
	auto rOut = r;
...
luabind::object Lua::util::read_scene_file(lua::State *l, const std::string &fileName)
{
	...
	fPushValue = [l, &fPushValue](const source_engine::script::SceneScriptValue &val) {
		...
		PushString(l, "identifier");
		PushString(l, val.identifier);
		SetTableValue(l, t);
		PushString(l, "parameters");
		auto tParams = CreateTable(l);
		auto paramIdx = 1u;
		for(auto &param : val.parameters) {
			PushInt(l, paramIdx++);
			PushString(l, param);
			SetTableValue(l, tParams);
		}
		SetTableValue(l, t);
		PushString(l, "children");
		auto tChildren = CreateTable(l);
		auto childIdx = 1u;
		for(auto &child : val.subValues) {
			PushInt(l, childIdx++);
			fPushValue(*child);
			SetTableValue(l, tChildren);
		}
		SetTableValue(l, t);
	};
	fPushValue(root);
...
static luabind::object fade_property_generic(pragma::Game &game, lua::State *l, TProperty &vProp, const TUnderlyingType &vDst, float duration, const std::function<TUnderlyingType(const TUnderlyingType &, const TUnderlyingType &, float)> &fLerp)
{
...
template<class TProperty, typename TUnderlyingType>
luabind::object fade_vector_property_generic(pragma::Game &game, lua::State *l, TProperty &vProp, const TUnderlyingType &vDst, float duration, const std::function<TUnderlyingType(const TUnderlyingType &, const TUnderlyingType &, float)> &fLerp)
{
...
luabind::object Lua::util::fade_property(lua::State *l, LVector3iProperty &vProp, const Vector3i &vDst, float duration)
{
	auto &game = *pragma::Engine::Get()->GetNetworkState(l)->GetGameState();
	return fade_vector_property_generic<LVector3iProperty, Vector3i>(game, l, vProp, vDst, duration, uvec::lerp);
}
luabind::object Lua::util::fade_property(lua::State *l, LVector4Property &vProp, const ::Vector4 &vDst, float duration)
{
	auto &game = *pragma::Engine::Get()->GetNetworkState(l)->GetGameState();
...
luabind::object Lua::util::fade_property(lua::State *l, LEulerAnglesProperty &vProp, const EulerAngles &vDst, float duration)
{
	auto &game = *pragma::Engine::Get()->GetNetworkState(l)->GetGameState();
	return fade_vector_property_generic<LEulerAnglesProperty, EulerAngles>(game, l, vProp, vDst, duration, [](const EulerAngles &a, const EulerAngles &b, float factor) -> EulerAngles {
		return EulerAngles {static_cast<float>(pragma::math::lerp_angle(a.p, b.p, factor)), static_cast<float>(pragma::math::lerp_angle(a.y, b.y, factor)), static_cast<float>(pragma::math::lerp_angle(a.r, b.r, factor))};
	});
}
...
{
	if(IsSet(l, 1) == false)
		return IsNone(l, 1) ? "none" : "nil";
	auto *crep = get_crep(o);
	if(crep)
		return crep->name();
...
luabind::object Lua::util::get_class_value(lua::State *l, const luabind::object &oClass, const std::string &key)
{
	...
	PushString(l, key);                    /* 1 */
	auto r = GetProtectedTableValue(l, t); /* 2 */
	if(r != StatusCode::Ok) {
		Pop(l, GetStackTop(l) - n);
		return {};
	}
	// Pop key from stack
	RemoveValue(l, -2); /* 1 */
...
Lua::var<bool, pragma::util::ParallelJob<luabind::object>> Lua::util::pack_zip_archive(lua::State *l, pragma::Game &game, const std::string &pzipFileName, const luabind::table<> &t)
{
	...
	zipFileName += ".zip";
	if(file::validate_write_operation(l, zipFileName) == false)
	...
	auto numFiles = GetObjectLength(l, t);
	if(numFiles > 0) {
		...
		for(luabind::iterator i(t), e; i != e; ++i) {
			...
			auto value = *i;
			if(static_cast<Type>(luabind::type(value)) == Type::Table) {
