...
pragma::physics::IKController::IKController(const std::string &effectorName, uint32_t chainLength, const std::string &type, pragma::physics::ik::Method method) : m_effectorName(effectorName), m_chainLength(chainLength), m_type(type), m_method(method) {}
...
void pragma::physics::IKController::SetMethod(pragma::physics::ik::Method method) { m_method = method; }
