...
uint8_t pragma::physics::PhysWaterSurfaceSimulator::GetEdgeIterationCount() const { return Engine::Get()->GetServerNetworkState()->GetConVarValueOr<udm::Int32>("sv_water_surface_simulation_edge_iteration_count"); }
