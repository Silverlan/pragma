...
struct IAnyHandler {
	...
	virtual void Read(pragma::Game &game, util::DataStream &ds, std::any &outValue) const = 0;
...
struct EntityHandler : public IAnyHandler {
	...
	virtual void Read(pragma::Game &game, util::DataStream &ds, std::any &outValue) const override
	{
