...
export namespace pragma {
	...
	namespace baseCharacterComponent {
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_FOOT_STEP;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_CHARACTER_ORIENTATION_CHANGED;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_DEPLOY_WEAPON;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_SET_ACTIVE_WEAPON;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_PLAY_FOOTSTEP_SOUND;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_IS_MOVING;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_HANDLE_VIEW_ROTATION;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_JUMP;
	}
