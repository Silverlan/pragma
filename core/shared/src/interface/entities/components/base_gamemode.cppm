...
export namespace pragma {
	...
	namespace baseGamemodeComponent {
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PLAYER_DEATH;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PLAYER_SPAWNED;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PLAYER_DROPPED;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PLAYER_READY;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PLAYER_JOINED;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_GAME_INITIALIZED;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_MAP_INITIALIZED;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_GAME_READY;
	}
