...
export {
	...
	namespace pragma {
		...
		namespace basePhysicsComponent {
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PHYSICS_INITIALIZED;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PHYSICS_DESTROYED;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PHYSICS_UPDATED;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_DYNAMIC_PHYSICS_UPDATED;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PRE_PHYSICS_SIMULATE;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_POST_PHYSICS_SIMULATE;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_SLEEP;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_WAKE;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_HANDLE_RAYCAST;
			CLASS_ENUM_COMPAT ComponentEventId EVENT_INITIALIZE_PHYSICS;
		}
