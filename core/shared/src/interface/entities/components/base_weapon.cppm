...
export namespace pragma {
	...
	namespace baseWeaponComponent {
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_DEPLOY;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_HOLSTER;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PRIMARY_ATTACK;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_SECONDARY_ATTACK;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_TERTIARY_ATTACK;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_ATTACK4;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_END_PRIMARY_ATTACK;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_END_SECONDARY_ATTACK;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_RELOAD;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_PRIMARY_CLIP_SIZE_CHANGED;
		CLASS_ENUM_COMPAT ComponentEventId EVENT_ON_SECONDARY_CLIP_SIZE_CHANGED;
	}
