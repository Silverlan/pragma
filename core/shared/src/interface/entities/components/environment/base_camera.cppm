	...
	namespace pragma {
		...
		class DLLNETWORK BaseEnvCameraComponent : public BaseEntityComponent {
		  public:
			...
			void GetFrustumPlanes(std::vector<pragma::math::Plane> &outPlanes) const;
			...
			const pragma::util::PMatrix4Property &GetProjectionMatrixProperty() const;
			const pragma::util::PMatrix4Property &GetViewMatrixProperty() const;

			const pragma::util::PFloatProperty &GetAspectRatioProperty() const;
			const pragma::util::PFloatProperty &GetNearZProperty() const;
			const pragma::util::PFloatProperty &GetFarZProperty() const;
			const pragma::util::PFloatProperty &GetFOVProperty() const;
			const pragma::util::PFloatProperty &GetFocalDistanceProperty() const;
			...
			void CreateFrustumKDop(const Vector2 &uvStart, const Vector2 &uvEnd, std::vector<pragma::math::Plane> &kDop) const;
			...
			static void CreateFrustumKDop(const std::vector<pragma::math::Plane> &planes, const std::vector<Vector3> &points, const Vector3 &dir, std::vector<pragma::math::Plane> *kDop);
			static Mat4 CalcProjectionMatrix(pragma::math::Radian fovRad, float aspectRatio, float nearZ, float farZ, const rendering::Tile *optTile = nullptr);
			static void GetFrustumPlanes(const std::vector<Vector3> &points, std::vector<pragma::math::Plane> &outPlanes);
			static void GetFrustumPlanes(std::vector<pragma::math::Plane> &outPlanes, float neard, float fard, float fov, float ratio, const Vector3 &center, const Vector3 &viewDir, const Vector3 &viewUp);
		  protected:
			void FlagViewMatrixAsDirty();
			void FlagProjectionMatrixAsDirty();
			virtual void SetFieldAngleComponent(BaseFieldAngleComponent &c);
		  private:
			pragma::util::PMatrix4Property m_projectionMatrix = nullptr;
			pragma::util::PMatrix4Property m_viewMatrix = nullptr;
			pragma::util::PFloatProperty m_aspectRatio = nullptr;
			pragma::util::PFloatProperty m_nearZ = nullptr;
			pragma::util::PFloatProperty m_farZ = nullptr;
			pragma::util::PFloatProperty m_focalDistance = nullptr;
