...
export namespace pragma {
	class DLLNETWORK VelocityComponent final : public BaseEntityComponent {
	  public:
		...
		const pragma::util::PVector3Property &GetVelocityProperty() const;
		const pragma::util::PVector3Property &GetAngularVelocityProperty() const;
	  ...
	  protected:
		pragma::util::PVector3Property m_velocity;
		pragma::util::PVector3Property m_angVelocity;
	};
};
