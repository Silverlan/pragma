...
export {
	namespace bulletInfo {
		STATIC_CONST_COMPAT float DEFAULT_TRACER_RADIUS = 1.f;
		STATIC_CONST_COMPAT Color DEFAULT_TRACER_COLOR = Color(510, 510, 180, 510);
		STATIC_CONST_COMPAT float DEFAULT_TRACER_LENGTH = 200.f;
		STATIC_CONST_COMPAT float DEFAULT_TRACER_SPEED = 6'000.f;
		STATIC_CONST_COMPAT std::string DEFAULT_TRACER_MATERIAL = "particles/beam_tracer";
		STATIC_CONST_COMPAT float DEFAULT_TRACER_BLOOM = 0.25f;
	}
