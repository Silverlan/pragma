...
export {
	namespace Lua::console {
		ConVar *CreateConVar(lua::State *l, const std::string &cmd, ::udm::Type type, Lua::udm_type def, pragma::console::ConVarFlags flags = pragma::console::ConVarFlags::None, const std::string &help = "");
		void CreateConCommand(lua::State *l, const std::string &name, const Lua::func<void, pragma::BasePlayerComponent, float, Lua::variadic<std::string>> &function, pragma::console::ConVarFlags flags, const std::string &help);
		void CreateConCommand(lua::State *l, const std::string &name, const Lua::func<void, pragma::BasePlayerComponent, float, Lua::variadic<std::string>> &function, pragma::console::ConVarFlags flags);
		void CreateConCommand(lua::State *l, const std::string &name, const Lua::func<void, pragma::BasePlayerComponent, float, Lua::variadic<std::string>> &function, const std::string &help);
		ConVar *GetConVar(lua::State *l, const std::string &name);
