...
export {
	namespace Lua::console {
		pragma::console::ConVar *CreateConVar(lua::State *l, const std::string &cmd, ::udm::Type type, Lua::udm_type def, pragma::console::ConVarFlags flags = pragma::console::ConVarFlags::None, const std::string &help = "");
