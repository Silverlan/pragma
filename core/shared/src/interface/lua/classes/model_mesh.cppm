...
export namespace Lua {
	...
	namespace ModelSubMesh {
		...
		DLLNETWORK void AddTriangle(lua::State *l, pragma::geometry::ModelSubMesh &mdl, const umath::Vertex &v1, const umath::Vertex &v2, const umath::Vertex &v3);
		...
		DLLNETWORK void AddVertex(lua::State *l, pragma::geometry::ModelSubMesh &mdl, const umath::Vertex &v);
		DLLNETWORK void GetBounds(lua::State *l, pragma::geometry::ModelSubMesh &mdl);
		DLLNETWORK void SetVertex(lua::State *l, pragma::geometry::ModelSubMesh &mdl, uint32_t idx, const umath::Vertex &v);
		...
		DLLNETWORK void SetVertexWeight(lua::State *l, pragma::geometry::ModelSubMesh &mdl, uint32_t idx, const umath::VertexWeight &weight);
