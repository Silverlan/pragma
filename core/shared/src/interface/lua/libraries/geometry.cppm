...
export module pragma.client:scripting.lua.libraries.geometry;
...
export namespace Lua {
	namespace geometry {
		...
		DLLNETWORK void generate_truncated_cone_mesh(lua_State *l, const Vector3 &origin, float startRadius, const Vector3 &dir, float dist, float endRadius, luabind::object &outVerts, luabind::object &outTris, luabind::object &outNormals, uint32_t segmentCount = 12, bool caps = true,
