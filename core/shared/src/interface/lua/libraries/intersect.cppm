...
export namespace Lua {
	namespace intersect {
		...
		DLLNETWORK void line_mesh(lua_State *l, const Vector3 &rayStart, const Vector3 &rayDir, pragma::ModelSubMesh &mesh, luabind::object &r0, luabind::object &r1, bool precise = false, const umath::Transform &meshPose = {});
		...
		DLLNETWORK void line_mesh(lua_State *l, const Vector3 &rayStart, const Vector3 &rayDir, pragma::Model &mdl, uint32_t lod, luabind::object &r0, luabind::object &r1, bool precise = false, const umath::Transform &meshPose = {});
		DLLNETWORK void line_mesh(lua_State *l, const Vector3 &rayStart, const Vector3 &rayDir, pragma::Model &mdl, luabind::table<> tBodyGroups, luabind::object &r0, luabind::object &r1, bool precise = false, const umath::Transform &meshPose = {});
