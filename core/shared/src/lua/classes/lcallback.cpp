...
static bool operator==(const CallbackHandler &a,const CallbackHandler &b)
{
			...
			void CallCallbacks(lua_State *l,::CallbackHandler &cbHandler,std::string name,TARGS ...args)
		{
			...
			for(auto it=callbacks->begin();it!=callbacks->end();)
			{
				...
				else
				{
					...
					Lua::CallFunction(l,[&o,&cbHandler,numArgs,argOffset](lua_State *l) {
						o.push(l);
...
void Lua::CallbackHandler::CallCallbacks(lua_State *l,::CallbackHandler &cbHandler,const std::string &name)
{
	CallCallbacks<>(l,cbHandler,name);
}
void Lua::CallbackHandler::CallCallbacks(lua_State *l,::CallbackHandler &cbHandler,const std::string &name,luabind::object o1)
{
	CallCallbacks<luabind::object>(l,cbHandler,name,o1);
}
void Lua::CallbackHandler::CallCallbacks(lua_State *l,::CallbackHandler &cbHandler,const std::string &name,luabind::object o1,luabind::object o2)
{
	CallCallbacks<luabind::object,luabind::object>(l,cbHandler,name,o1,o2);
}
void Lua::CallbackHandler::CallCallbacks(lua_State *l,::CallbackHandler &cbHandler,const std::string &name,luabind::object o1,luabind::object o2,luabind::object o3)
{
	CallCallbacks<luabind::object,luabind::object,luabind::object>(l,cbHandler,name,o1,o2,o3);
}
...
{
	Lua::PushBool(l,callback.IsValid());
}

DLLNETWORK void Lua_Callback_Remove(lua_State*,CallbackHandle &callback)
{
	callback.Remove();
}