...
namespace Lua
{
	namespace PhysCollisionObj
	{
		...
		static void SetWorldTransform(lua_State *l,pragma::physics::ICollisionObject *hPhys,const pragma::physics::Transform &t);
	};
...
void Lua::PhysCollisionObj::register_class(lua_State *l,luabind::module_ &mod)
{
	...
	classDefGhost.def("IsValid",static_cast<void(*)(lua_State*,pragma::physics::IGhostObject*)>([](lua_State *l,pragma::physics::IGhostObject *hPhys) {
...
void Lua::PhysCollisionObj::IsValid(lua_State *l,pragma::physics::ICollisionObject *hPhys)
{
	Lua::PushBool(l,hPhys != nullptr);
}
...
void Lua::PhysCollisionObj::SetWorldTransform(lua_State *l,pragma::physics::ICollisionObject *hPhys,const pragma::physics::Transform &t)
{
	if(Lua::CheckHandle<pragma::physics::ICollisionObject>(l,hPhys) == false)
		return;
...
void Lua::PhysRigidBody::IsValid(lua_State *l,pragma::physics::IRigidBody *hPhys)
{
	Lua::PushBool(l,hPhys != nullptr);
}
...
void Lua::PhysSoftBody::IsValid(lua_State *l,pragma::physics::ISoftBody *hPhys)
{
	Lua::PushBool(l,hPhys != nullptr);
}
