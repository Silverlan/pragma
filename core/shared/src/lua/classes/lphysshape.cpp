...
namespace Lua
{
	namespace PhysShape
	{
		static void GetBounds(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape);
		static void IsConvex(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape);
		static void IsConvexHull(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape);
		static void IsHeightField(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape);
		static void IsTriangleShape(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape);
	};
	namespace PhysConvexShape
	{
		static void GetCollisionMesh(lua_State *l,util::TSharedHandle<pragma::physics::IConvexShape> &shape);
	};
	namespace PhysConvexHullShape
	{
		static void AddPoint(lua_State *l,util::TSharedHandle<pragma::physics::IConvexHullShape> &shape,Vector3 &point);
	};
	namespace PhysHeightfield
	{
		static void GetHeight(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape,uint32_t x,uint32_t y);
		static void SetHeight(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape,uint32_t x,uint32_t y,float height);
		static void GetWidth(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape);
		static void GetLength(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape);
		static void GetMaxHeight(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape);
		static void GetUpAxis(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape);
	};
};

void Lua::PhysShape::register_class(lua_State *l,luabind::module_ &mod)
{
	auto classDef = luabind::class_<pragma::physics::IShape>("Shape");
	...
	classDef.def("CalculateLocalInertia",static_cast<void(*)(lua_State*,util::TSharedHandle<pragma::physics::IShape>&,float)>([](lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape,float mass) {
	...
	auto convexClassDef = luabind::class_<pragma::physics::IConvexShape,pragma::physics::IShape>("ConvexShape");
	convexClassDef.def("GetCollisionMesh",PhysConvexShape::GetCollisionMesh);
	mod[convexClassDef];

	auto hullClassDef = luabind::class_<pragma::physics::IConvexHullShape,pragma::physics::IConvexShape>("ConvexHullShape");
	hullClassDef.def("AddPoint",PhysConvexHullShape::AddPoint);
	mod[hullClassDef];

	auto heightfieldClassDef = luabind::class_<pragma::physics::IHeightfield,pragma::physics::IShape>("Heightfield");
	...
	auto triangleShapeClassDef = luabind::class_<pragma::physics::ITriangleShape,pragma::physics::IShape>("TriangleShape");
#if 0
...
void Lua::PhysShape::GetBounds(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape)
{
	Vector3 min,max;
...
void Lua::PhysShape::IsConvex(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape)
{
	Lua::PushBool(l,shape->IsConvex());
}
void Lua::PhysShape::IsConvexHull(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape)
{
	Lua::PushBool(l,shape->IsConvexHull());
}
void Lua::PhysShape::IsHeightField(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape)
{
	Lua::PushBool(l,shape->IsHeightfield());
}
void Lua::PhysShape::IsTriangleShape(lua_State *l,util::TSharedHandle<pragma::physics::IShape> &shape)
{
...
void Lua::PhysConvexShape::GetCollisionMesh(lua_State *l,util::TSharedHandle<pragma::physics::IConvexShape> &shape)
{
...
void Lua::PhysConvexHullShape::AddPoint(lua_State*,util::TSharedHandle<pragma::physics::IConvexHullShape> &shape,Vector3 &point)
{
...
void Lua::PhysHeightfield::GetHeight(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape,uint32_t x,uint32_t y)
{
	Lua::PushInt(l,shape->GetHeight(x,y));
}
void Lua::PhysHeightfield::SetHeight(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape,uint32_t x,uint32_t y,float height)
{
	shape->SetHeight(x,y,height);
}
void Lua::PhysHeightfield::GetWidth(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape)
{
	Lua::PushInt(l,shape->GetWidth());
}
void Lua::PhysHeightfield::GetLength(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape)
{
	Lua::PushInt(l,shape->GetLength());
}
void Lua::PhysHeightfield::GetMaxHeight(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape)
{
	Lua::PushNumber(l,shape->GetMaxHeight());
}
void Lua::PhysHeightfield::GetUpAxis(lua_State *l,util::TSharedHandle<pragma::physics::IHeightfield> &shape)
{
