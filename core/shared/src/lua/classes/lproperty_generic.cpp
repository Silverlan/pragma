...
LGenericFloatPropertyWrapper::LGenericFloatPropertyWrapper(const util::PFloatProperty &prop)
	: m_property(prop),m_propertyType(ArithmeticFloatPropertyType::Float)
{}
LGenericFloatPropertyWrapper::LGenericFloatPropertyWrapper(const util::PDoubleProperty &prop)
	: m_property(prop),m_propertyType(ArithmeticFloatPropertyType::Double)
{}
LGenericFloatPropertyWrapper::LGenericFloatPropertyWrapper(const util::PLongDoubleProperty &prop)
	: m_property(prop),m_propertyType(ArithmeticFloatPropertyType::LongDouble)
{}
LGenericFloatPropertyWrapper::LGenericFloatPropertyWrapper(double v)
	: LGenericFloatPropertyWrapper(util::DoubleProperty::Create(v))
{}
LGenericFloatPropertyWrapper::LGenericFloatPropertyWrapper()
	: LGenericFloatPropertyWrapper(0.0)
{}
...
void LGenericFloatPropertyWrapper::LinkOther(util::StringProperty &prop)
{
	...
	{
		case ArithmeticFloatPropertyType::Float:
			prop.Link<util::FloatProperty,float>(static_cast<util::FloatProperty&>(*m_property),[](const float &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticFloatPropertyType::Double:
			prop.Link<util::DoubleProperty,double>(static_cast<util::DoubleProperty&>(*m_property),[](const double &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticFloatPropertyType::LongDouble:
			prop.Link<util::LongDoubleProperty,long double>(static_cast<util::LongDoubleProperty&>(*m_property),[](const long double &other) -> std::string {
				return std::to_string(other);
			});
			break;
	}
...
void LGenericFloatPropertyWrapper::Link(util::StringProperty &prop)
{
	...
	{
		case ArithmeticFloatPropertyType::Float:
			static_cast<util::FloatProperty&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> float {
				return util::to_float(other);
			});
			break;
		case ArithmeticFloatPropertyType::Double:
			static_cast<util::DoubleProperty&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> double {
				return static_cast<double>(util::to_float(other));
			});
			break;
		case ArithmeticFloatPropertyType::LongDouble:
			static_cast<util::LongDoubleProperty&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> long double {
				return static_cast<long double>(util::to_float(other));
			});
			break;
	}
}
...
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PInt8Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::Int8)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PUInt8Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::UInt8)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PInt16Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::Int16)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PUInt16Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::UInt16)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PInt32Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::Int32)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PUInt32Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::UInt32)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PInt64Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::Int64)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(const util::PUInt64Property &prop)
	: m_property(prop),m_propertyType(ArithmeticIntPropertyType::UInt64)
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper(int32_t v)
	: LGenericIntPropertyWrapper(util::Int32Property::Create(v))
{}
LGenericIntPropertyWrapper::LGenericIntPropertyWrapper()
	: LGenericIntPropertyWrapper(0)
{}
...
void LGenericIntPropertyWrapper::LinkOther(util::StringProperty &prop)
{
	...
	{
		case ArithmeticIntPropertyType::Int8:
			prop.Link<util::Int8Property,int8_t>(static_cast<util::Int8Property&>(*m_property),[](const int8_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt8:
			prop.Link<util::UInt8Property,uint8_t>(static_cast<util::UInt8Property&>(*m_property),[](const uint8_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticIntPropertyType::Int16:
			prop.Link<util::Int16Property,int16_t>(static_cast<util::Int16Property&>(*m_property),[](const int16_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt16:
			prop.Link<util::UInt16Property,uint16_t>(static_cast<util::UInt16Property&>(*m_property),[](const uint16_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticIntPropertyType::Int32:
			prop.Link<util::Int32Property,int32_t>(static_cast<util::Int32Property&>(*m_property),[](const int32_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt32:
			prop.Link<util::UInt32Property,uint32_t>(static_cast<util::UInt32Property&>(*m_property),[](const uint32_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticIntPropertyType::Int64:
			prop.Link<util::Int64Property,int64_t>(static_cast<util::Int64Property&>(*m_property),[](const int64_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt64:
			prop.Link<util::UInt64Property,uint64_t>(static_cast<util::UInt64Property&>(*m_property),[](const uint64_t &other) -> std::string {
				return std::to_string(other);
			});
			break;
	}
...
void LGenericIntPropertyWrapper::Link(util::StringProperty &prop)
{
	...
	{
		case ArithmeticIntPropertyType::Int8:
			static_cast<util::Int8Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> int8_t {
				return util::to_int(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt8:
			static_cast<util::UInt8Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> uint8_t {
				return util::to_int(other);
			});
			break;
		case ArithmeticIntPropertyType::Int16:
			static_cast<util::Int16Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> int16_t {
				return util::to_int(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt16:
			static_cast<util::UInt16Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> uint16_t {
				return util::to_int(other);
			});
			break;
		case ArithmeticIntPropertyType::Int32:
			static_cast<util::Int32Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> int32_t {
				return util::to_int(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt32:
			static_cast<util::UInt32Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> uint32_t {
				return util::to_int(other);
			});
			break;
		case ArithmeticIntPropertyType::Int64:
			static_cast<util::Int64Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> int64_t {
				return util::to_int(other);
			});
			break;
		case ArithmeticIntPropertyType::UInt64:
			static_cast<util::UInt64Property&>(*m_property).Link<util::StringProperty,std::string>(prop,[](const std::string &other) -> uint64_t {
				return util::to_int(other);
			});
			break;
	}
