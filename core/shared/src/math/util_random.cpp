...
std::uniform_real_distribution<float> util::to_random_float(const std::string &s) { return to_random_number<std::uniform_real_distribution<float>, float>(s, static_cast<float (*)(const std::string_view &)>(util::to_float)); }
...
std::uniform_int_distribution<int32_t> util::to_random_int(const std::string &s) { return to_random_number<std::uniform_int_distribution<int32_t>, int32_t>(s, static_cast<int32_t (*)(const std::string_view &)>(util::to_int)); }
