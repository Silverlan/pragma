...
pragma::networking::Error::Error(ErrorCode errCode,const std::string &message,std::optional<int32_t> nativeErrCode)
	: m_message{message},m_nativeErrCode{nativeErrCode}
{}
