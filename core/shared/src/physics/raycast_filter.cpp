...
RayCastHitType pragma::physics::EntityRayCastFilterCallback::PostFilter(pragma::physics::IShape &shape,pragma::physics::IRigidBody &rigidBody) const
{
...
pragma::physics::MultiEntityRayCastFilterCallback::MultiEntityRayCastFilterCallback(std::vector<EntityHandle> &&ents)
...
RayCastHitType pragma::physics::MultiEntityRayCastFilterCallback::PostFilter(pragma::physics::IShape &shape,pragma::physics::IRigidBody &rigidBody) const
{
	return RayCastHitType::None;
}
...
pragma::physics::PhysObjRayCastFilterCallback::PhysObjRayCastFilterCallback(PhysObj &physObj)
	: m_hPhys{physObj.GetHandle()}
{}
...
RayCastHitType pragma::physics::PhysObjRayCastFilterCallback::PostFilter(pragma::physics::IShape &shape,pragma::physics::IRigidBody &rigidBody) const
{
	return RayCastHitType::None;
}
...
pragma::physics::CollisionObjRayCastFilterCallback::CollisionObjRayCastFilterCallback(ICollisionObject &colObj)
	: m_hColObj{util::weak_shared_handle_cast<IBase,ICollisionObject>(colObj.GetHandle())}
{}
RayCastHitType pragma::physics::CollisionObjRayCastFilterCallback::PreFilter(pragma::physics::IShape &shape,pragma::physics::IRigidBody &rigidBody) const
{
	return (&rigidBody == m_hColObj.Get()) ? RayCastHitType::Block : RayCastHitType::None;
}
RayCastHitType pragma::physics::CollisionObjRayCastFilterCallback::PostFilter(pragma::physics::IShape &shape,pragma::physics::IRigidBody &rigidBody) const
{
	return RayCastHitType::None;
}
...
pragma::physics::CustomRayCastFilterCallback::CustomRayCastFilterCallback(
...
{}
RayCastHitType pragma::physics::CustomRayCastFilterCallback::PreFilter(pragma::physics::IShape &shape,pragma::physics::IRigidBody &rigidBody) const
{
	return m_preFilter(shape,rigidBody);
}
RayCastHitType pragma::physics::CustomRayCastFilterCallback::PostFilter(pragma::physics::IShape &shape,pragma::physics::IRigidBody &rigidBody) const
{
	return m_postFilter(shape,rigidBody);
}
