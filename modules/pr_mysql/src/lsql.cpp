...
void Lua::sql::register_lua_library(Lua::Interface &l)
{
	...
	auto classDefConnection = luabind::class_<::sql::BaseConnection>("Connection");
	classDefConnection.def("Close",&Connection::Close);
	classDefConnection.def("Execute",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&,const luabind::object&,const luabind::object&)>(&Connection::Execute));
	classDefConnection.def("Execute",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&,const luabind::object&)>(&Connection::Execute));
	classDefConnection.def("Execute",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&)>(&Connection::Execute));
	classDefConnection.def("ExecuteQueryAndFetchRows",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&,const luabind::object&,const luabind::object&)>(&Connection::ExecuteQueryAndFetchRows));
	classDefConnection.def("ExecuteQueryAndFetchRows",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&,const luabind::object&)>(&Connection::ExecuteQueryAndFetchRows));
	classDefConnection.def("ExecuteQueryAndFetchRows",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&)>(&Connection::ExecuteQueryAndFetchRows));
	classDefConnection.def("GetLastInsertRowId",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const luabind::object&)>(&Connection::GetLastInsertRowId));
	classDefConnection.def("GetLastInsertRowId",static_cast<void(*)(lua_State*,::sql::BaseConnection&)>(&Connection::GetLastInsertRowId));
	classDefConnection.def("CreateStatement",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&)>(&Connection::CreateStatement));
	classDefConnection.def("CreateStatement",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&,const luabind::object&)>(&Connection::CreateStatement));
	classDefConnection.def("CreatePreparedStatement",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&)>(&Connection::CreatePreparedStatement));
	classDefConnection.def("CreatePreparedStatement",static_cast<void(*)(lua_State*,::sql::BaseConnection&,const std::string&,const luabind::object&)>(&Connection::CreatePreparedStatement));
	...
	auto classDefStatement = luabind::class_<::sql::BaseStatement>("Statement");
	classDefStatement.def("Step",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const luabind::object&)>(&Statement::Step));
	classDefStatement.def("Step",static_cast<void(*)(lua_State*,::sql::BaseStatement&)>(&Statement::Step));
	classDefStatement.def("ExecuteQuery",static_cast<void(*)(lua_State*,::sql::BaseStatement&)>(&Statement::ExecuteQuery));
	classDefStatement.def("ExecuteQuery",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const luabind::object&)>(&Statement::ExecuteQuery));
	classDefStatement.def("Finalize",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const luabind::object&)>(&Statement::Finalize));
	classDefStatement.def("Finalize",static_cast<void(*)(lua_State*,::sql::BaseStatement&)>(&Statement::Finalize));
	classDefStatement.def("Reset",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const luabind::object&)>(&Statement::Reset));
	classDefStatement.def("Reset",static_cast<void(*)(lua_State*,::sql::BaseStatement&)>(&Statement::Reset));
	classDefStatement.def("FindColumn",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const std::string&,const luabind::object&)>(&Statement::FindColumn));
	classDefStatement.def("FindColumn",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const std::string&)>(&Statement::FindColumn));
	classDefStatement.def("IsReadOnly",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::IsReadOnly));
	classDefStatement.def("IsReadOnly",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::IsReadOnly));
	classDefStatement.def("GetType",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetType));
	classDefStatement.def("GetType",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetType));
	classDefStatement.def("GetDouble",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetDouble));
	classDefStatement.def("GetDouble",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetDouble));
	classDefStatement.def("GetInt",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetInt));
	classDefStatement.def("GetInt",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetInt));
	classDefStatement.def("GetInt64",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetInt64));
	classDefStatement.def("GetInt64",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetInt64));
	classDefStatement.def("GetText",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetText));
	classDefStatement.def("GetText",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetText));
	classDefStatement.def("GetBlob",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetBlob));
	classDefStatement.def("GetBlob",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetBlob));
	classDefStatement.def("GetColumnCount",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const luabind::object&)>(&Statement::GetColumnCount));
	classDefStatement.def("GetColumnCount",static_cast<void(*)(lua_State*,::sql::BaseStatement&)>(&Statement::GetColumnCount));
	classDefStatement.def("GetColumnName",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetColumnName));
	classDefStatement.def("GetColumnName",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetColumnName));
	classDefStatement.def("GetRowCount",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const luabind::object&)>(&Statement::GetRowCount));
	classDefStatement.def("GetRowCount",static_cast<void(*)(lua_State*,::sql::BaseStatement&)>(&Statement::GetRowCount));
	classDefStatement.def("GetValue",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t,const luabind::object&)>(&Statement::GetValue));
	classDefStatement.def("GetValue",static_cast<void(*)(lua_State*,::sql::BaseStatement&,int32_t)>(&Statement::GetValue));
	classDefStatement.def("ExecuteQueryAndFetchRows",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const std::string&,const luabind::object&)>(&Statement::ExecuteQueryAndFetchRows));
	classDefStatement.def("ExecuteQueryAndFetchRows",static_cast<void(*)(lua_State*,::sql::BaseStatement&,const std::string&)>(&Statement::ExecuteQueryAndFetchRows));
